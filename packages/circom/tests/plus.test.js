...
describe("Plus Regex", () => {
    ...
    it("plus1 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/plus1.json"),
                "utf8"
            )
        )[0];
    ...
    it("plus2 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/plus2.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
    ...
    it("plus3 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/plus3.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
    ...
    it("plus4 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/plus4.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
    ...
    it("plus5 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/plus5.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
    ...
    it("plus6 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/plus6.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
