...
describe("Question Regex", () => {
    ...
    beforeAll(async () => {
        ...
        writeFileSync(
            path.join(__dirname, "./circuits/question4_regex.circom"),
            compiler.genFromDecomposed(
                readFileSync(
                    path.join(__dirname, "./circuits/question4.json"),
                    "utf8"
                ),
                "Question4Regex"
            )
        ...
        circuit4 = await wasm_tester(
            path.join(__dirname, "./circuits/test_question4_regex.circom"),
            option
        );
    });
    ...
    it("question1 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/question1.json"),
                "utf8"
            )
        )[0];
    ...
    it("question1 valid case 4", async () => {
        const inputStr = `61ab8aa8`;
        const paddedStr = apis.padString(inputStr, 8);
        const circuitInputs = {
            msg: paddedStr,
        };
    ...
    it("question2 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/question2.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
    ...
    it("question3 valid case 1", async () => {
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/question3.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
    ...
    it("question3 valid case 3", async () => {
    ...
    it("question4 valid case 1", async () => {
        const inputStr = `12c`;
        const paddedStr = apis.padString(inputStr, 8);
        const circuitInputs = {
            msg: paddedStr,
        ...
        const prefixIdxes = apis.extractSubstrIdxes(
            inputStr,
            readFileSync(
                path.join(__dirname, "../circuits/common/question4.json"),
                "utf8"
            )
        )[0];
        for (let idx = 0; idx < 8; ++idx) {
    ...
    it("question4 valid case 2", async () => {
        const inputStr = `12ac`;
        const paddedStr = apis.padString(inputStr, 8);
        const circuitInputs = {
            msg: paddedStr,
    ...
    it("question4 valid case 4", async () => {
    ...
    it("question4 invalid case 1", async () => {
        const inputStr = `1ac`;
        const paddedStr = apis.padString(inputStr, 8);
        const circuitInputs = {
            msg: paddedStr,
    ...
    it("question4 invalid case 2", async () => {
    ...
    it("question4 invalid case 3", async () => {
