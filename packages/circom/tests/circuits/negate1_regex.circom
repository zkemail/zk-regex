...
template Negate1Regex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		lt[5][i].in[1] <== 191;
		and[7][i] = AND();
		and[7][i].a <== lt[4][i].out;
		and[7][i].b <== lt[5][i].out;
		and[8][i] = AND();
		...
		multi_or[2][i].in[11] <== eq[14][i].out;
		multi_or[2][i].in[12] <== eq[15][i].out;
		multi_or[2][i].in[13] <== eq[16][i].out;
		...
		multi_or[3][i].in[14] <== eq[31][i].out;
		multi_or[3][i].in[15] <== eq[32][i].out;
		...
		multi_or[5][i].in[4] <== and[18][i].out;
		...
		multi_or[9][i].in[0] <== eq[36][i].out;
		multi_or[9][i].in[1] <== eq[35][i].out;
		...
		multi_or[13][i].in[1] <== and[28][i].out;
		multi_or[13][i].in[2] <== eq[43][i].out;
		multi_or[13][i].in[3] <== eq[42][i].out;
		multi_or[13][i].in[4] <== eq[39][i].out;
		multi_or[13][i].in[5] <== eq[40][i].out;
		multi_or[13][i].in[6] <== eq[41][i].out;
		and[30][i].b <== multi_or[13][i].out;
		and[31][i] = AND();
		and[31][i].a <== states[i][3];
		and[31][i].b <== and[7][i].out;
		multi_or[14][i] = MultiOR(3);
		multi_or[14][i].in[0] <== and[29][i].out;
		multi_or[14][i].in[1] <== and[30][i].out;
		multi_or[14][i].in[2] <== and[31][i].out;
	...
	// substrings calculated: [{(10, 6), (10, 7), (2, 7), (2, 4), (2, 8), (2, 10), (10, 3), (3, 10), (10, 10), (10, 9), (10, 8), (4, 3), (5, 3), (2, 9), (8, 5), (10, 4), (9, 5), (6, 3), (2, 5), (2, 6), (7, 5), (2, 3), (10, 5)}]
