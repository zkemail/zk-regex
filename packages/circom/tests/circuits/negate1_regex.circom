...
template Negate1Regex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[4][i].in[3] <== eq[3][i].out;
		multi_or[4][i].in[4] <== eq[8][i].out;
		multi_or[4][i].in[5] <== eq[5][i].out;
		...
		multi_or[13][i].in[3] <== eq[41][i].out;
		multi_or[13][i].in[4] <== eq[42][i].out;
		multi_or[13][i].in[5] <== eq[40][i].out;
		multi_or[13][i].in[6] <== eq[39][i].out;
		and[30][i].b <== multi_or[13][i].out;
		and[31][i] = AND();
		and[31][i].a <== states[i][3];
		and[31][i].b <== and[9][i].out;
	...
	// substrings calculated: [{(2, 10), (6, 3), (3, 10), (9, 5), (2, 6), (10, 5), (4, 3), (10, 3), (2, 8), (10, 10), (10, 7), (7, 5), (2, 4), (2, 3), (2, 9), (2, 7), (10, 4), (2, 5), (8, 5), (5, 3), (10, 6), (10, 9), (10, 8)}]
