...
template Negate1Regex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		lt[13][i].in[1] <== 191;
		and[22][i] = AND();
		and[22][i].a <== lt[12][i].out;
		and[22][i].b <== lt[13][i].out;
		and[23][i] = AND();
		...
		multi_or[11][i].in[1] <== eq[36][i].out;
