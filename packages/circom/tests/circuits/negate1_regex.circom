...
template Negate1Regex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[2] <== and[13][i].out;
		multi_or[2][i].in[3] <== and[14][i].out;
		...
		multi_or[5][i].in[4] <== eq[15][i].out;
		multi_or[5][i].in[5] <== eq[8][i].out;
		multi_or[5][i].in[6] <== eq[10][i].out;
		multi_or[5][i].in[7] <== eq[4][i].out;
		multi_or[5][i].in[8] <== eq[9][i].out;
		multi_or[5][i].in[9] <== eq[3][i].out;
		multi_or[5][i].in[10] <== eq[13][i].out;
		multi_or[5][i].in[11] <== eq[14][i].out;
		multi_or[5][i].in[12] <== eq[7][i].out;
		multi_or[5][i].in[13] <== eq[11][i].out;
		and[21][i].b <== multi_or[5][i].out;
		and[22][i] = AND();
		and[22][i].a <== states[i][9];
		and[22][i].b <== and[2][i].out;
		eq[17][i] = IsEqual();
		eq[17][i].in[0] <== in[i];
		eq[17][i].in[1] <== 140;
		eq[18][i] = IsEqual();
		...
		multi_or[7][i].in[3] <== and[22][i].out;
		multi_or[7][i].in[4] <== and[23][i].out;
	...
	// substrings calculated: [{(4, 3), (2, 3), (2, 6), (5, 4), (9, 6), (3, 7), (3, 4), (7, 4), (3, 8), (8, 6), (10, 6), (2, 4), (2, 7), (6, 4), (3, 10), (3, 9), (2, 10), (3, 3), (2, 5), (3, 6), (3, 5), (2, 9), (2, 8)}]
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][3] * states[i+2][3];
		is_substr0[i][10] <== is_substr0[i][9] + states[i+1][3] * states[i+2][4];
		is_substr0[i][11] <== is_substr0[i][10] + states[i+1][3] * states[i+2][5];
		is_substr0[i][12] <== is_substr0[i][11] + states[i+1][3] * states[i+2][6];
		is_substr0[i][13] <== is_substr0[i][12] + states[i+1][3] * states[i+2][7];
		is_substr0[i][14] <== is_substr0[i][13] + states[i+1][3] * states[i+2][8];
		is_substr0[i][15] <== is_substr0[i][14] + states[i+1][3] * states[i+2][9];
		is_substr0[i][16] <== is_substr0[i][15] + states[i+1][3] * states[i+2][10];
		is_substr0[i][17] <== is_substr0[i][16] + states[i+1][4] * states[i+2][3];
		is_substr0[i][18] <== is_substr0[i][17] + states[i+1][5] * states[i+2][4];
		is_substr0[i][19] <== is_substr0[i][18] + states[i+1][6] * states[i+2][4];
		is_substr0[i][20] <== is_substr0[i][19] + states[i+1][7] * states[i+2][4];
		is_substr0[i][21] <== is_substr0[i][20] + states[i+1][8] * states[i+2][6];
		is_substr0[i][22] <== is_substr0[i][21] + states[i+1][9] * states[i+2][6];
		is_substr0[i][23] <== is_substr0[i][22] + states[i+1][10] * states[i+2][6];
