...
template InternationalCharsDecomposed(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[6][i].in[0] <== eq[22][i].out;
		multi_or[6][i].in[1] <== eq[21][i].out;
		and[32][i].b <== multi_or[6][i].out;
		multi_or[7][i] = MultiOR(2);
		multi_or[7][i].in[0] <== and[31][i].out;
		multi_or[7][i].in[1] <== and[32][i].out;
		states[i+1][27] <== multi_or[7][i].out;
		...
		multi_or[8][i].in[1] <== and[34][i].out;
		states[i+1][28] <== multi_or[8][i].out;
		state_changed[i].in[27] <== states[i+1][28];
		and[35][i] = AND();
		and[35][i].a <== states[i][27];
		and[35][i].b <== and[22][i].out;
		eq[24][i] = IsEqual();
		eq[24][i].in[0] <== in[i];
		eq[24][i].in[1] <== 178;
		eq[25][i] = IsEqual();
		...
		multi_or[9][i].in[14] <== eq[38][i].out;
		multi_or[9][i].in[15] <== eq[39][i].out;
		and[36][i].b <== multi_or[9][i].out;
		multi_or[10][i] = MultiOR(2);
		multi_or[10][i].in[0] <== and[35][i].out;
		multi_or[10][i].in[1] <== and[36][i].out;
		...
		and[47][i].b <== multi_or[11][i].out;
		and[48][i] = AND();
		and[48][i].a <== states[i][41];
		multi_or[12][i] = MultiOR(4);
		multi_or[12][i].in[0] <== eq[45][i].out;
		multi_or[12][i].in[1] <== eq[47][i].out;
		multi_or[12][i].in[2] <== eq[46][i].out;
		multi_or[12][i].in[3] <== eq[44][i].out;
		and[48][i].b <== multi_or[12][i].out;
		multi_or[13][i] = MultiOR(2);
		multi_or[13][i].in[0] <== and[47][i].out;
		multi_or[13][i].in[1] <== and[48][i].out;
		states[i+1][40] <== multi_or[13][i].out;
		state_changed[i].in[39] <== states[i+1][40];
		and[49][i] = AND();
		and[49][i].a <== states[i][40];
		and[49][i].b <== and[22][i].out;
		...
		eq[53][i].in[1] <== 219;
		and[58][i] = AND();
		and[58][i].a <== states[i][51];
		multi_or[14][i] = MultiOR(4);
		multi_or[14][i].in[0] <== eq[50][i].out;
		multi_or[14][i].in[1] <== eq[51][i].out;
		multi_or[14][i].in[2] <== eq[52][i].out;
		multi_or[14][i].in[3] <== eq[53][i].out;
		and[58][i].b <== multi_or[14][i].out;
		and[59][i] = AND();
		and[59][i].a <== states[i][49];
		multi_or[15][i] = MultiOR(4);
		multi_or[15][i].in[0] <== eq[50][i].out;
		multi_or[15][i].in[1] <== eq[52][i].out;
		multi_or[15][i].in[2] <== eq[53][i].out;
		multi_or[15][i].in[3] <== eq[51][i].out;
		and[59][i].b <== multi_or[15][i].out;
		multi_or[16][i] = MultiOR(2);
		multi_or[16][i].in[0] <== and[58][i].out;
		multi_or[16][i].in[1] <== and[59][i].out;
		states[i+1][50] <== multi_or[16][i].out;
		state_changed[i].in[49] <== states[i+1][50];
		and[60][i] = AND();
		and[60][i].a <== states[i][50];
		and[60][i].b <== and[22][i].out;
		...
		eq[57][i].in[1] <== 224;
		and[73][i] = AND();
		and[73][i].a <== states[i][66];
		and[73][i].b <== eq[57][i].out;
		and[74][i] = AND();
		and[74][i].a <== states[i][63];
		and[74][i].b <== eq[57][i].out;
		multi_or[17][i] = MultiOR(2);
		multi_or[17][i].in[0] <== and[73][i].out;
		multi_or[17][i].in[1] <== and[74][i].out;
		states[i+1][64] <== multi_or[17][i].out;
		...
		multi_or[18][i].in[0] <== eq[58][i].out;
		multi_or[18][i].in[1] <== eq[59][i].out;
		and[75][i].b <== multi_or[18][i].out;
		states[i+1][65] <== and[75][i].out;
		state_changed[i].in[64] <== states[i+1][65];
		and[76][i] = AND();
		and[76][i].a <== states[i][65];
		and[76][i].b <== and[22][i].out;
		...
		multi_or[19][i].in[0] <== and[96][i].out;
		multi_or[19][i].in[1] <== and[97][i].out;
		states[i+1][86] <== multi_or[19][i].out;
		...
		multi_or[21][i].in[0] <== and[100][i].out;
		multi_or[21][i].in[1] <== and[102][i].out;
		states[i+1][89] <== multi_or[21][i].out;
	...
	// substrings calculated: [{(16, 17), (16, 18), (18, 19), (19, 18), (17, 19), (19, 17)}, {(26, 28), (28, 29), (27, 29), (29, 27), (29, 28), (26, 27)}, {(39, 40), (40, 41), (41, 40)}, {(49, 50), (50, 51), (51, 50)}, {(65, 66), (66, 64), (64, 65), (63, 64)}, {(88, 89), (89, 86), (87, 89), (85, 86), (86, 87), (86, 88)}]
