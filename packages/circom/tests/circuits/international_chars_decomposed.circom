...
template InternationalCharsDecomposed(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[2] <== eq[15][i].out;
		multi_or[1][i].in[3] <== eq[12][i].out;
		and[17][i].b <== multi_or[1][i].out;
		multi_or[2][i] = MultiOR(2);
		multi_or[2][i].in[0] <== and[16][i].out;
		multi_or[2][i].in[1] <== and[17][i].out;
		...
		multi_or[5][i].in[0] <== eq[21][i].out;
		multi_or[5][i].in[1] <== eq[22][i].out;
		...
		multi_or[7][i].in[1] <== and[34][i].out;
		states[i+1][28] <== multi_or[7][i].out;
		...
		multi_or[8][i].in[0] <== eq[24][i].out;
		multi_or[8][i].in[1] <== eq[25][i].out;
		multi_or[8][i].in[2] <== eq[26][i].out;
		multi_or[8][i].in[3] <== eq[27][i].out;
		multi_or[8][i].in[4] <== eq[28][i].out;
		multi_or[8][i].in[5] <== eq[29][i].out;
		multi_or[8][i].in[6] <== eq[30][i].out;
		multi_or[8][i].in[7] <== eq[31][i].out;
		multi_or[8][i].in[8] <== eq[32][i].out;
		multi_or[8][i].in[9] <== eq[33][i].out;
		multi_or[8][i].in[10] <== eq[34][i].out;
		multi_or[8][i].in[11] <== eq[35][i].out;
		multi_or[8][i].in[12] <== eq[36][i].out;
		multi_or[8][i].in[13] <== eq[37][i].out;
		multi_or[8][i].in[14] <== eq[38][i].out;
		multi_or[8][i].in[15] <== eq[39][i].out;
		and[36][i].b <== multi_or[8][i].out;
		multi_or[9][i] = MultiOR(2);
		multi_or[9][i].in[0] <== and[35][i].out;
		multi_or[9][i].in[1] <== and[36][i].out;
		states[i+1][29] <== multi_or[9][i].out;
		...
		eq[47][i].in[1] <== 209;
		and[47][i] = AND();
		and[47][i].a <== states[i][41];
		multi_or[10][i] = MultiOR(4);
		multi_or[10][i].in[0] <== eq[44][i].out;
		multi_or[10][i].in[1] <== eq[45][i].out;
		multi_or[10][i].in[2] <== eq[46][i].out;
		multi_or[10][i].in[3] <== eq[47][i].out;
		and[47][i].b <== multi_or[10][i].out;
		and[48][i] = AND();
		and[48][i].a <== states[i][39];
		multi_or[11][i] = MultiOR(4);
		multi_or[11][i].in[0] <== eq[46][i].out;
		multi_or[11][i].in[1] <== eq[47][i].out;
		multi_or[11][i].in[2] <== eq[45][i].out;
		multi_or[11][i].in[3] <== eq[44][i].out;
		and[48][i].b <== multi_or[11][i].out;
		multi_or[12][i] = MultiOR(2);
		multi_or[12][i].in[0] <== and[47][i].out;
		multi_or[12][i].in[1] <== and[48][i].out;
		states[i+1][40] <== multi_or[12][i].out;
		...
		multi_or[13][i].in[0] <== eq[50][i].out;
		multi_or[13][i].in[1] <== eq[51][i].out;
		multi_or[13][i].in[2] <== eq[52][i].out;
		multi_or[13][i].in[3] <== eq[53][i].out;
		and[58][i].b <== multi_or[13][i].out;
		and[59][i] = AND();
		and[59][i].a <== states[i][51];
		multi_or[14][i] = MultiOR(4);
		multi_or[14][i].in[0] <== eq[53][i].out;
		multi_or[14][i].in[1] <== eq[52][i].out;
		multi_or[14][i].in[2] <== eq[51][i].out;
		multi_or[14][i].in[3] <== eq[50][i].out;
		and[59][i].b <== multi_or[14][i].out;
		multi_or[15][i] = MultiOR(2);
		multi_or[15][i].in[0] <== and[58][i].out;
		multi_or[15][i].in[1] <== and[59][i].out;
		states[i+1][50] <== multi_or[15][i].out;
		...
		multi_or[16][i].in[0] <== and[73][i].out;
		multi_or[16][i].in[1] <== and[74][i].out;
		...
		multi_or[17][i].in[0] <== eq[58][i].out;
		multi_or[17][i].in[1] <== eq[59][i].out;
		and[75][i].b <== multi_or[17][i].out;
		...
		eq[63][i].in[1] <== 227;
		and[96][i] = AND();
		and[96][i].a <== states[i][89];
		and[96][i].b <== eq[63][i].out;
		and[97][i] = AND();
		and[97][i].a <== states[i][85];
		and[97][i].b <== eq[63][i].out;
		multi_or[18][i] = MultiOR(2);
		multi_or[18][i].in[0] <== and[96][i].out;
		multi_or[18][i].in[1] <== and[97][i].out;
		states[i+1][86] <== multi_or[18][i].out;
		...
		and[99][i].b <== multi_or[19][i].out;
		states[i+1][88] <== and[99][i].out;
		state_changed[i].in[87] <== states[i+1][88];
		and[100][i] = AND();
		and[100][i].a <== states[i][88];
		and[100][i].b <== and[20][i].out;
		lt[4][i] = LessEqThan(8);
		lt[4][i].in[0] <== 129;
		lt[4][i].in[1] <== in[i];
		lt[5][i] = LessEqThan(8);
		...
		lt[5][i].in[1] <== 191;
		and[101][i] = AND();
		and[101][i].a <== lt[4][i].out;
		and[101][i].b <== lt[5][i].out;
		and[102][i] = AND();
		and[102][i].a <== states[i][87];
		and[102][i].b <== and[101][i].out;
		multi_or[20][i] = MultiOR(2);
		multi_or[20][i].in[0] <== and[100][i].out;
		multi_or[20][i].in[1] <== and[102][i].out;
		states[i+1][89] <== multi_or[20][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_consecutive[msg_bytes-1-i][0] <== states[num_bytes-i][89] * (1 - is_consecutive[msg_bytes-i][1]) + is_consecutive[msg_bytes-i][1];
		is_consecutive[msg_bytes-1-i][1] <== state_changed[msg_bytes-i].out * is_consecutive[msg_bytes-1-i][0];
	}
	// substrings calculated: [{(19, 18), (19, 17), (17, 19), (16, 18), (16, 17), (18, 19)}, {(26, 27), (26, 28), (27, 29), (28, 29), (29, 28), (29, 27)}, {(39, 40), (41, 40), (40, 41)}, {(51, 50), (50, 51), (49, 50)}, {(63, 64), (66, 64), (64, 65), (65, 66)}, {(87, 89), (88, 89), (89, 86), (86, 88), (85, 86), (86, 87)}]
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][16] * states[i+2][17];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][16] * states[i+2][18];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][17] * states[i+2][19];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][18] * states[i+2][19];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][19] * states[i+2][17];
		is_substr0[i][6] <== is_substr0[i][5] + states[i+1][19] * states[i+2][18];
		is_reveal0[i] <== is_substr0[i][6] * is_consecutive[i][1];
		reveal0[i] <== in[i+1] * is_reveal0[i];
	}
	signal is_substr1[msg_bytes][7];
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr1[i][1] <== is_substr1[i][0] + states[i+1][26] * states[i+2][27];
		is_substr1[i][2] <== is_substr1[i][1] + states[i+1][26] * states[i+2][28];
		is_substr1[i][3] <== is_substr1[i][2] + states[i+1][27] * states[i+2][29];
		is_substr1[i][4] <== is_substr1[i][3] + states[i+1][28] * states[i+2][29];
		is_substr1[i][5] <== is_substr1[i][4] + states[i+1][29] * states[i+2][27];
		is_substr1[i][6] <== is_substr1[i][5] + states[i+1][29] * states[i+2][28];
		is_reveal1[i] <== is_substr1[i][6] * is_consecutive[i][1];
		reveal1[i] <== in[i+1] * is_reveal1[i];
	}
	signal is_substr2[msg_bytes][4];
	signal is_reveal2[msg_bytes];
	signal output reveal2[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		is_substr2[i][0] <== 0;
		 // the 2-th substring transitions: [(39, 40), (40, 41), (41, 40)]
		is_substr2[i][1] <== is_substr2[i][0] + states[i+1][39] * states[i+2][40];
		is_substr2[i][2] <== is_substr2[i][1] + states[i+1][40] * states[i+2][41];
		is_substr2[i][3] <== is_substr2[i][2] + states[i+1][41] * states[i+2][40];
		is_reveal2[i] <== is_substr2[i][3] * is_consecutive[i][1];
		reveal2[i] <== in[i+1] * is_reveal2[i];
	}
	signal is_substr3[msg_bytes][4];
	signal is_reveal3[msg_bytes];
	signal output reveal3[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		is_substr3[i][0] <== 0;
		 // the 3-th substring transitions: [(49, 50), (50, 51), (51, 50)]
		is_substr3[i][1] <== is_substr3[i][0] + states[i+1][49] * states[i+2][50];
		is_substr3[i][2] <== is_substr3[i][1] + states[i+1][50] * states[i+2][51];
		is_substr3[i][3] <== is_substr3[i][2] + states[i+1][51] * states[i+2][50];
		is_reveal3[i] <== is_substr3[i][3] * is_consecutive[i][1];
		reveal3[i] <== in[i+1] * is_reveal3[i];
	}
	signal is_substr4[msg_bytes][5];
	signal is_reveal4[msg_bytes];
	signal output reveal4[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		is_substr4[i][0] <== 0;
		 // the 4-th substring transitions: [(63, 64), (64, 65), (65, 66), (66, 64)]
		is_substr4[i][1] <== is_substr4[i][0] + states[i+1][63] * states[i+2][64];
		is_substr4[i][2] <== is_substr4[i][1] + states[i+1][64] * states[i+2][65];
		is_substr4[i][3] <== is_substr4[i][2] + states[i+1][65] * states[i+2][66];
		is_substr4[i][4] <== is_substr4[i][3] + states[i+1][66] * states[i+2][64];
		is_reveal4[i] <== is_substr4[i][4] * is_consecutive[i][1];
		reveal4[i] <== in[i+1] * is_reveal4[i];
	}
	signal is_substr5[msg_bytes][7];
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr5[i][1] <== is_substr5[i][0] + states[i+1][85] * states[i+2][86];
		is_substr5[i][2] <== is_substr5[i][1] + states[i+1][86] * states[i+2][87];
		is_substr5[i][3] <== is_substr5[i][2] + states[i+1][86] * states[i+2][88];
		is_substr5[i][4] <== is_substr5[i][3] + states[i+1][87] * states[i+2][89];
		is_substr5[i][5] <== is_substr5[i][4] + states[i+1][88] * states[i+2][89];
		is_substr5[i][6] <== is_substr5[i][5] + states[i+1][89] * states[i+2][86];
		is_reveal5[i] <== is_substr5[i][6] * is_consecutive[i][1];
