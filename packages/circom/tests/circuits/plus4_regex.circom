...
template Plus4Regex(msg_bytes) {
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i] <== MultiOR(7)([states[i+1][0] * states[i+2][1], states[i+1][0] * states[i+2][2], states[i+1][1] * states[i+2][3], states[i+1][2] * states[i+2][4], states[i+1][3] * states[i+2][4], states[i+1][4] * states[i+2][1], states[i+1][4] * states[i+2][2]]);
