...
template Caret5Regex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[4] <== and[10][i].out;
		...
		multi_or[3][i].in[4] <== eq[8][i].out;
		multi_or[3][i].in[5] <== eq[9][i].out;
		multi_or[3][i].in[6] <== eq[10][i].out;
		multi_or[3][i].in[7] <== eq[11][i].out;
		multi_or[3][i].in[8] <== eq[12][i].out;
		multi_or[3][i].in[9] <== eq[13][i].out;
		multi_or[3][i].in[10] <== eq[14][i].out;
		multi_or[3][i].in[11] <== eq[15][i].out;
		multi_or[3][i].in[12] <== eq[16][i].out;
		multi_or[3][i].in[13] <== eq[17][i].out;
		...
		multi_or[4][i].in[14] <== eq[32][i].out;
		multi_or[4][i].in[15] <== eq[33][i].out;
		...
		multi_or[8][i].in[0] <== eq[36][i].out;
		multi_or[8][i].in[1] <== eq[37][i].out;
