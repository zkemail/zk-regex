...
template Caret5Regex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[5][i].in[1] <== eq[5][i].out;
		multi_or[5][i].in[2] <== eq[6][i].out;
		multi_or[5][i].in[3] <== eq[7][i].out;
		multi_or[5][i].in[4] <== eq[8][i].out;
		multi_or[5][i].in[5] <== eq[9][i].out;
		multi_or[5][i].in[6] <== eq[10][i].out;
		multi_or[5][i].in[7] <== eq[11][i].out;
		multi_or[5][i].in[8] <== eq[12][i].out;
		multi_or[5][i].in[9] <== eq[13][i].out;
		multi_or[5][i].in[10] <== eq[14][i].out;
		multi_or[5][i].in[11] <== eq[15][i].out;
		...
		multi_or[10][i].in[0] <== eq[36][i].out;
