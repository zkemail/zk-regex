...
template BodyHashRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[3][i].in[2] <== and[20][i].out;
		multi_or[3][i].in[3] <== and[21][i].out;
		multi_or[3][i].in[4] <== and[22][i].out;
		...
		multi_or[5][i] = MultiOR(12);
		multi_or[5][i].in[0] <== eq[18][i].out;
		multi_or[5][i].in[1] <== eq[3][i].out;
		multi_or[5][i].in[2] <== eq[19][i].out;
		multi_or[5][i].in[3] <== eq[20][i].out;
		multi_or[5][i].in[4] <== eq[6][i].out;
		multi_or[5][i].in[5] <== eq[21][i].out;
		multi_or[5][i].in[6] <== eq[15][i].out;
		multi_or[5][i].in[7] <== eq[16][i].out;
		multi_or[5][i].in[8] <== eq[10][i].out;
		multi_or[5][i].in[9] <== eq[17][i].out;
		multi_or[5][i].in[10] <== eq[0][i].out;
		multi_or[5][i].in[11] <== eq[14][i].out;
		and[25][i].b <== multi_or[5][i].out;
		and[26][i] = AND();
		and[26][i].a <== states[i][20];
		...
		multi_or[6][i].in[1] <== eq[8][i].out;
		multi_or[6][i].in[2] <== eq[23][i].out;
		and[27][i].b <== multi_or[6][i].out;
		and[28][i] = AND();
		and[28][i].a <== states[i][32];
		multi_or[7][i] = MultiOR(8);
		multi_or[7][i].in[0] <== eq[18][i].out;
		multi_or[7][i].in[1] <== eq[19][i].out;
		multi_or[7][i].in[2] <== eq[20][i].out;
		multi_or[7][i].in[3] <== eq[21][i].out;
		multi_or[7][i].in[4] <== eq[16][i].out;
		multi_or[7][i].in[5] <== eq[17][i].out;
		multi_or[7][i].in[6] <== eq[0][i].out;
		multi_or[7][i].in[7] <== eq[14][i].out;
		and[28][i].b <== multi_or[7][i].out;
		multi_or[8][i] = MultiOR(4);
		multi_or[8][i].in[0] <== and[25][i].out;
		multi_or[8][i].in[1] <== and[26][i].out;
		multi_or[8][i].in[2] <== and[27][i].out;
		multi_or[8][i].in[3] <== and[28][i].out;
		...
		and[32][i] = AND();
		and[32][i].a <== states[i][23];
		and[32][i].b <== multi_or[6][i].out;
		and[33][i] = AND();
		and[33][i].a <== states[i][24];
		multi_or[9][i] = MultiOR(2);
		multi_or[9][i].in[0] <== eq[22][i].out;
		multi_or[9][i].in[1] <== eq[8][i].out;
		and[33][i].b <== multi_or[9][i].out;
		and[34][i] = AND();
		and[34][i].a <== states[i][32];
		and[34][i].b <== eq[24][i].out;
		multi_or[10][i] = MultiOR(6);
		multi_or[10][i].in[0] <== and[29][i].out;
		multi_or[10][i].in[1] <== and[30][i].out;
		multi_or[10][i].in[2] <== and[31][i].out;
		multi_or[10][i].in[3] <== and[32][i].out;
		multi_or[10][i].in[4] <== and[33][i].out;
		multi_or[10][i].in[5] <== and[34][i].out;
		states[i+1][21] <== multi_or[10][i].out;
		and[35][i] = AND();
		and[35][i].a <== states[i][19];
		and[35][i].b <== eq[2][i].out;
		and[36][i] = AND();
		...
		states[i+1][22] <== multi_or[11][i].out;
		eq[25][i] = IsEqual();
		eq[25][i].in[0] <== in[i];
		eq[25][i].in[1] <== 19;
		and[38][i] = AND();
		...
		multi_or[13][i].in[0] <== eq[8][i].out;
		multi_or[13][i].in[1] <== eq[23][i].out;
		and[40][i].b <== multi_or[13][i].out;
		and[41][i] = AND();
		and[41][i].a <== states[i][26];
		and[41][i].b <== multi_or[6][i].out;
		and[42][i] = AND();
		...
		multi_or[14][i].in[3] <== and[41][i].out;
		multi_or[14][i].in[4] <== and[42][i].out;
		multi_or[14][i].in[5] <== and[43][i].out;
		...
		multi_or[15][i].in[0] <== and[44][i].out;
		multi_or[15][i].in[1] <== and[45][i].out;
		multi_or[15][i].in[2] <== and[46][i].out;
		...
		multi_or[16][i].in[0] <== and[47][i].out;
		multi_or[16][i].in[1] <== and[48][i].out;
		multi_or[16][i].in[2] <== and[49][i].out;
		states[i+1][25] <== multi_or[16][i].out;
		and[50][i] = AND();
		and[50][i].a <== states[i][19];
		and[50][i].b <== eq[13][i].out;
		and[51][i] = AND();
		and[51][i].a <== states[i][20];
		and[51][i].b <== eq[13][i].out;
		and[52][i] = AND();
		and[52][i].a <== states[i][32];
		and[52][i].b <== eq[13][i].out;
		multi_or[17][i] = MultiOR(3);
		multi_or[17][i].in[0] <== and[50][i].out;
		multi_or[17][i].in[1] <== and[51][i].out;
		multi_or[17][i].in[2] <== and[52][i].out;
		...
		multi_or[18][i].in[2] <== and[55][i].out;
		states[i+1][27] <== multi_or[18][i].out;
		and[56][i] = AND();
		and[56][i].a <== states[i][20];
		and[56][i].b <== eq[1][i].out;
		states[i+1][28] <== and[56][i].out;
		and[57][i] = AND();
		and[57][i].a <== states[i][28];
		and[57][i].b <== eq[3][i].out;
		states[i+1][29] <== and[57][i].out;
		and[58][i] = AND();
		and[58][i].a <== states[i][29];
		and[58][i].b <== eq[16][i].out;
		states[i+1][30] <== and[58][i].out;
		and[59][i] = AND();
		and[59][i].a <== states[i][30];
		and[59][i].b <== eq[17][i].out;
		states[i+1][31] <== and[59][i].out;
		and[60][i] = AND();
		and[60][i].a <== states[i][31];
		and[60][i].b <== eq[6][i].out;
		states[i+1][32] <== and[60][i].out;
		and[61][i] = AND();
		and[61][i].a <== states[i][32];
		multi_or[19][i] = MultiOR(5);
		multi_or[19][i].in[0] <== eq[3][i].out;
		multi_or[19][i].in[1] <== eq[1][i].out;
		multi_or[19][i].in[2] <== eq[6][i].out;
		multi_or[19][i].in[3] <== eq[15][i].out;
		multi_or[19][i].in[4] <== eq[10][i].out;
		and[61][i].b <== multi_or[19][i].out;
		and[62][i] = AND();
		and[62][i].a <== states[i][33];
		multi_or[20][i] = MultiOR(4);
		multi_or[20][i].in[0] <== eq[1][i].out;
		multi_or[20][i].in[1] <== eq[6][i].out;
		multi_or[20][i].in[2] <== eq[15][i].out;
		multi_or[20][i].in[3] <== eq[10][i].out;
		and[62][i].b <== multi_or[20][i].out;
		multi_or[21][i] = MultiOR(2);
		multi_or[21][i].in[0] <== and[61][i].out;
		multi_or[21][i].in[1] <== and[62][i].out;
		states[i+1][33] <== multi_or[21][i].out;
		and[63][i] = AND();
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i] <== MultiOR(2)([states[i+1][32] * states[i+2][33], states[i+1][33] * states[i+2][33]]);
