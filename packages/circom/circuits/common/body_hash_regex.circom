...
template BodyHashRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		lt[11][i].in[1] <== 42;
		and[11][i] = AND();
		and[11][i].a <== lt[10][i].out;
		and[11][i].b <== lt[11][i].out;
		...
		lt[15][i].in[1] <== 90;
		and[18][i] = AND();
		and[18][i].a <== lt[14][i].out;
		and[18][i].b <== lt[15][i].out;
		eq[23][i] = IsEqual();
		eq[23][i].in[0] <== in[i];
		eq[23][i].in[1] <== 43;
		eq[24][i] = IsEqual();
		...
		eq[44][i].in[1] <== 116;
		and[40][i] = AND();
		and[40][i].a <== states[i][20];
		and[40][i].b <== eq[44][i].out;
		states[i+1][21] <== and[40][i].out;
		state_changed[i].in[20] <== states[i+1][21];
		eq[45][i] = IsEqual();
		eq[45][i].in[0] <== in[i];
		eq[45][i].in[1] <== 117;
		and[41][i] = AND();
		and[41][i].a <== states[i][21];
		and[41][i].b <== eq[45][i].out;
		states[i+1][22] <== and[41][i].out;
		...
		and[42][i].b <== eq[46][i].out;
		states[i+1][23] <== and[42][i].out;
		state_changed[i].in[22] <== states[i+1][23];
		and[43][i] = AND();
		and[43][i].a <== states[i][23];
		and[43][i].b <== eq[4][i].out;
		states[i+1][24] <== and[43][i].out;
		state_changed[i].in[23] <== states[i+1][24];
		and[44][i] = AND();
		and[44][i].a <== states[i][24];
		and[44][i].b <== eq[10][i].out;
		states[i+1][25] <== and[44][i].out;
		state_changed[i].in[24] <== states[i+1][25];
		and[45][i] = AND();
		and[45][i].a <== states[i][7];
		and[45][i].b <== eq[1][i].out;
		states[i+1][26] <== and[45][i].out;
