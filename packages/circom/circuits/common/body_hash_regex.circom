...
template BodyHashRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[6][i].in[7] <== eq[24][i].out;
		multi_or[6][i].in[8] <== eq[25][i].out;
		...
		multi_or[12][i].in[0] <== and[48][i].out;
		multi_or[12][i].in[1] <== and[49][i].out;
		multi_or[12][i].in[2] <== and[51][i].out;
		multi_or[12][i].in[3] <== and[52][i].out;
		multi_or[12][i].in[4] <== and[53][i].out;
		multi_or[12][i].in[5] <== and[54][i].out;
		...
		multi_or[13][i].in[0] <== and[55][i].out;
		multi_or[13][i].in[1] <== and[56][i].out;
		multi_or[13][i].in[2] <== and[57][i].out;
		...
		multi_or[14][i].in[0] <== and[58][i].out;
		multi_or[14][i].in[1] <== and[59][i].out;
		multi_or[14][i].in[2] <== and[60][i].out;
		...
		multi_or[15][i].in[0] <== eq[70][i].out;
		multi_or[15][i].in[1] <== eq[71][i].out;
		multi_or[15][i].in[2] <== eq[72][i].out;
		and[61][i].b <== multi_or[15][i].out;
		and[62][i] = AND();
		and[62][i].a <== states[i][20];
		and[62][i].b <== multi_or[15][i].out;
		and[63][i] = AND();
		and[63][i].a <== states[i][32];
		and[63][i].b <== multi_or[15][i].out;
		multi_or[16][i] = MultiOR(3);
		multi_or[16][i].in[0] <== and[61][i].out;
		multi_or[16][i].in[1] <== and[62][i].out;
		multi_or[16][i].in[2] <== and[63][i].out;
		states[i+1][26] <== multi_or[16][i].out;
		...
		multi_or[17][i].in[0] <== and[64][i].out;
		multi_or[17][i].in[1] <== and[65][i].out;
		multi_or[17][i].in[2] <== and[66][i].out;
		states[i+1][27] <== multi_or[17][i].out;
		...
		multi_or[18][i].in[0] <== and[72][i].out;
		multi_or[18][i].in[1] <== and[18][i].out;
		multi_or[18][i].in[2] <== eq[77][i].out;
		multi_or[18][i].in[3] <== eq[78][i].out;
		multi_or[18][i].in[4] <== eq[79][i].out;
		multi_or[18][i].in[5] <== eq[80][i].out;
		multi_or[18][i].in[6] <== eq[81][i].out;
		multi_or[18][i].in[7] <== eq[82][i].out;
		multi_or[18][i].in[8] <== eq[83][i].out;
		multi_or[18][i].in[9] <== eq[84][i].out;
		multi_or[18][i].in[10] <== eq[85][i].out;
		multi_or[18][i].in[11] <== eq[86][i].out;
		multi_or[18][i].in[12] <== eq[87][i].out;
		multi_or[18][i].in[13] <== eq[88][i].out;
		multi_or[18][i].in[14] <== eq[19][i].out;
		and[73][i].b <== multi_or[18][i].out;
		and[74][i] = AND();
		and[74][i].a <== states[i][33];
		and[74][i].b <== multi_or[18][i].out;
		multi_or[19][i] = MultiOR(2);
		multi_or[19][i].in[0] <== and[73][i].out;
		multi_or[19][i].in[1] <== and[74][i].out;
		states[i+1][33] <== multi_or[19][i].out;
