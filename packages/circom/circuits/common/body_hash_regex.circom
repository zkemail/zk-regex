...
template BodyHashRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[4][i].in[8] <== eq[14][i].out;
		multi_or[4][i].in[9] <== eq[15][i].out;
		multi_or[4][i].in[10] <== eq[16][i].out;
		multi_or[4][i].in[11] <== eq[17][i].out;
		multi_or[4][i].in[12] <== eq[18][i].out;
		multi_or[4][i].in[13] <== eq[19][i].out;
		multi_or[4][i].in[14] <== eq[20][i].out;
		multi_or[4][i].in[15] <== eq[21][i].out;
		...
		multi_or[5][i].in[3] <== eq[23][i].out;
		multi_or[5][i].in[4] <== eq[24][i].out;
		multi_or[5][i].in[5] <== eq[25][i].out;
		multi_or[5][i].in[6] <== eq[26][i].out;
		multi_or[5][i].in[7] <== eq[27][i].out;
		multi_or[5][i].in[8] <== eq[28][i].out;
		multi_or[5][i].in[9] <== eq[29][i].out;
		multi_or[5][i].in[10] <== eq[30][i].out;
		multi_or[5][i].in[11] <== eq[31][i].out;
		multi_or[5][i].in[12] <== eq[32][i].out;
		multi_or[5][i].in[13] <== eq[33][i].out;
		multi_or[5][i].in[14] <== eq[34][i].out;
		multi_or[5][i].in[15] <== eq[35][i].out;
		...
		lt[25][i].in[1] <== 254;
		and[20][i] = AND();
		and[20][i].a <== lt[24][i].out;
		and[20][i].b <== lt[25][i].out;
		and[21][i] = AND();
		...
		multi_or[7][i].in[0] <== and[12][i].out;
		multi_or[7][i].in[1] <== and[15][i].out;
		multi_or[7][i].in[2] <== and[18][i].out;
		multi_or[7][i].in[3] <== and[21][i].out;
		...
		eq[36][i].in[1] <== 61;
		and[22][i] = AND();
		and[22][i].a <== states[i][27];
		and[22][i].b <== eq[36][i].out;
		states[i+1][3] <== and[22][i].out;
		state_changed[i].in[2] <== states[i+1][3];
		eq[37][i] = IsEqual();
		eq[37][i].in[0] <== in[i];
		eq[37][i].in[1] <== 59;
		and[23][i] = AND();
		and[23][i].a <== states[i][2];
		and[23][i].b <== eq[37][i].out;
		...
		multi_or[8][i].in[2] <== eq[38][i].out;
		multi_or[8][i].in[3] <== eq[39][i].out;
		multi_or[8][i].in[4] <== eq[40][i].out;
		multi_or[8][i].in[5] <== eq[41][i].out;
		multi_or[8][i].in[6] <== eq[42][i].out;
		multi_or[8][i].in[7] <== eq[43][i].out;
		multi_or[8][i].in[8] <== eq[44][i].out;
		multi_or[8][i].in[9] <== eq[45][i].out;
		multi_or[8][i].in[10] <== eq[46][i].out;
		multi_or[8][i].in[11] <== eq[47][i].out;
		multi_or[8][i].in[12] <== eq[48][i].out;
		multi_or[8][i].in[13] <== eq[49][i].out;
		multi_or[8][i].in[14] <== eq[50][i].out;
		...
		multi_or[9][i].in[3] <== eq[52][i].out;
		multi_or[9][i].in[4] <== eq[53][i].out;
		multi_or[9][i].in[5] <== eq[54][i].out;
		multi_or[9][i].in[6] <== eq[55][i].out;
		multi_or[9][i].in[7] <== eq[56][i].out;
		multi_or[9][i].in[8] <== eq[57][i].out;
		multi_or[9][i].in[9] <== eq[58][i].out;
		multi_or[9][i].in[10] <== eq[59][i].out;
		multi_or[9][i].in[11] <== eq[60][i].out;
		multi_or[9][i].in[12] <== eq[61][i].out;
		multi_or[9][i].in[13] <== eq[62][i].out;
		multi_or[9][i].in[14] <== eq[63][i].out;
		...
		and[30][i].b <== eq[64][i].out;
		eq[65][i] = IsEqual();
		eq[65][i].in[0] <== in[i];
		eq[65][i].in[1] <== 61;
		and[31][i] = AND();
		and[31][i].a <== states[i][26];
		and[31][i].b <== eq[65][i].out;
		...
		eq[66][i].in[1] <== 32;
		and[32][i] = AND();
		and[32][i].a <== states[i][4];
		and[32][i].b <== eq[66][i].out;
		eq[67][i] = IsEqual();
		eq[67][i].in[0] <== in[i];
		eq[67][i].in[1] <== 32;
		and[33][i] = AND();
		and[33][i].a <== states[i][8];
		and[33][i].b <== eq[67][i].out;
		...
		and[34][i].b <== eq[68][i].out;
		states[i+1][8] <== and[34][i].out;
		...
		and[35][i].b <== eq[69][i].out;
		eq[70][i] = IsEqual();
		eq[70][i].in[0] <== in[i];
		eq[70][i].in[1] <== 13;
		and[36][i] = AND();
		and[36][i].a <== states[i][10];
		and[36][i].b <== eq[70][i].out;
		...
		and[37][i].b <== eq[71][i].out;
		eq[72][i] = IsEqual();
		eq[72][i].in[0] <== in[i];
		eq[72][i].in[1] <== 10;
		and[38][i] = AND();
		and[38][i].a <== states[i][9];
		and[38][i].b <== eq[72][i].out;
		...
		and[39][i].b <== eq[73][i].out;
		states[i+1][11] <== and[39][i].out;
		...
		and[40][i].b <== eq[74][i].out;
		states[i+1][12] <== and[40][i].out;
		state_changed[i].in[11] <== states[i+1][12];
		eq[75][i] = IsEqual();
		eq[75][i].in[0] <== in[i];
		eq[75][i].in[1] <== 105;
		and[41][i] = AND();
		and[41][i].a <== states[i][12];
		and[41][i].b <== eq[75][i].out;
		states[i+1][13] <== and[41][i].out;
		state_changed[i].in[12] <== states[i+1][13];
		eq[76][i] = IsEqual();
		eq[76][i].in[0] <== in[i];
		eq[76][i].in[1] <== 109;
		and[42][i] = AND();
		and[42][i].a <== states[i][13];
		and[42][i].b <== eq[76][i].out;
		states[i+1][14] <== and[42][i].out;
		...
		and[43][i].b <== eq[77][i].out;
		states[i+1][15] <== and[43][i].out;
		...
		and[44][i].b <== eq[78][i].out;
		states[i+1][16] <== and[44][i].out;
		...
		and[45][i].b <== eq[79][i].out;
		states[i+1][17] <== and[45][i].out;
		state_changed[i].in[16] <== states[i+1][17];
		eq[80][i] = IsEqual();
		eq[80][i].in[0] <== in[i];
		eq[80][i].in[1] <== 103;
		and[46][i] = AND();
		and[46][i].a <== states[i][17];
		and[46][i].b <== eq[80][i].out;
		states[i+1][18] <== and[46][i].out;
		state_changed[i].in[17] <== states[i+1][18];
		eq[81][i] = IsEqual();
		eq[81][i].in[0] <== in[i];
		eq[81][i].in[1] <== 110;
		and[47][i] = AND();
		and[47][i].a <== states[i][18];
		and[47][i].b <== eq[81][i].out;
		states[i+1][19] <== and[47][i].out;
		...
		and[48][i].b <== eq[82][i].out;
		states[i+1][20] <== and[48][i].out;
		...
		and[49][i].b <== eq[83][i].out;
		states[i+1][21] <== and[49][i].out;
		...
		and[50][i].b <== eq[84][i].out;
		states[i+1][22] <== and[50][i].out;
		...
		and[51][i].b <== eq[85][i].out;
		states[i+1][23] <== and[51][i].out;
		...
		and[52][i].b <== eq[86][i].out;
		states[i+1][24] <== and[52][i].out;
		...
		and[53][i].b <== eq[87][i].out;
		states[i+1][25] <== and[53][i].out;
		state_changed[i].in[24] <== states[i+1][25];
		eq[88][i] = IsEqual();
		eq[88][i].in[0] <== in[i];
		eq[88][i].in[1] <== 98;
		and[54][i] = AND();
		and[54][i].a <== states[i][7];
		and[54][i].b <== eq[88][i].out;
		states[i+1][26] <== and[54][i].out;
		...
		and[55][i].b <== eq[89][i].out;
		states[i+1][27] <== and[55][i].out;
