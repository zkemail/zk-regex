...
template BodyHashRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[9][i].in[3] <== eq[41][i].out;
		multi_or[9][i].in[4] <== eq[42][i].out;
		multi_or[9][i].in[5] <== eq[43][i].out;
		multi_or[9][i].in[6] <== eq[44][i].out;
		multi_or[9][i].in[7] <== eq[45][i].out;
		multi_or[9][i].in[8] <== eq[46][i].out;
		multi_or[9][i].in[9] <== eq[47][i].out;
		multi_or[9][i].in[10] <== eq[48][i].out;
		multi_or[9][i].in[11] <== eq[49][i].out;
		multi_or[9][i].in[12] <== eq[50][i].out;
		multi_or[9][i].in[13] <== eq[51][i].out;
		...
		multi_or[10][i].in[0] <== eq[52][i].out;
		multi_or[10][i].in[1] <== eq[53][i].out;
		multi_or[10][i].in[2] <== eq[54][i].out;
		multi_or[10][i].in[3] <== eq[55][i].out;
		multi_or[10][i].in[4] <== eq[56][i].out;
		multi_or[10][i].in[5] <== eq[57][i].out;
		multi_or[10][i].in[6] <== eq[58][i].out;
		multi_or[10][i].in[7] <== eq[59][i].out;
		multi_or[10][i].in[8] <== eq[60][i].out;
		multi_or[10][i].in[9] <== eq[61][i].out;
		multi_or[10][i].in[10] <== eq[62][i].out;
		multi_or[10][i].in[11] <== eq[63][i].out;
		multi_or[10][i].in[12] <== eq[64][i].out;
		multi_or[10][i].in[13] <== eq[65][i].out;
		multi_or[10][i].in[14] <== eq[66][i].out;
		multi_or[10][i].in[15] <== eq[67][i].out;
		...
		multi_or[17][i].in[2] <== eq[77][i].out;
		multi_or[17][i].in[3] <== eq[78][i].out;
		multi_or[17][i].in[4] <== eq[79][i].out;
		multi_or[17][i].in[5] <== eq[80][i].out;
		multi_or[17][i].in[6] <== eq[81][i].out;
		multi_or[17][i].in[7] <== eq[82][i].out;
		multi_or[17][i].in[8] <== eq[83][i].out;
		multi_or[17][i].in[9] <== eq[84][i].out;
		multi_or[17][i].in[10] <== eq[85][i].out;
		multi_or[17][i].in[11] <== eq[86][i].out;
		multi_or[17][i].in[12] <== eq[87][i].out;
		multi_or[17][i].in[13] <== eq[88][i].out;
		multi_or[17][i].in[14] <== eq[19][i].out;
