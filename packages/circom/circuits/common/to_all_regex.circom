...
template ToAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[10] <== eq[14][i].out;
		multi_or[1][i].in[11] <== eq[15][i].out;
		multi_or[1][i].in[12] <== eq[16][i].out;
		...
		and[15][i].b <== and[6][i].out;
		and[16][i] = AND();
		and[16][i].a <== states[i][5];
		and[16][i].b <== and[13][i].out;
		lt[8][i] = LessEqThan(8);
		lt[8][i].in[0] <== 160;
		lt[8][i].in[1] <== in[i];
		lt[9][i] = LessEqThan(8);
		...
		multi_or[6][i].in[0] <== eq[18][i].out;
		multi_or[6][i].in[1] <== eq[19][i].out;
		multi_or[6][i].in[2] <== eq[20][i].out;
		...
		multi_or[7][i].in[3] <== eq[23][i].out;
		multi_or[7][i].in[4] <== eq[28][i].out;
		multi_or[7][i].in[5] <== eq[29][i].out;
		multi_or[7][i].in[6] <== eq[21][i].out;
		multi_or[7][i].in[7] <== eq[30][i].out;
		multi_or[7][i].in[8] <== eq[22][i].out;
		multi_or[7][i].in[9] <== eq[20][i].out;
		multi_or[7][i].in[10] <== eq[19][i].out;
		multi_or[7][i].in[11] <== eq[26][i].out;
		multi_or[7][i].in[12] <== eq[31][i].out;
		multi_or[7][i].in[13] <== eq[18][i].out;
		...
		multi_or[8][i].in[0] <== eq[32][i].out;
		multi_or[8][i].in[1] <== eq[33][i].out;
		multi_or[8][i].in[2] <== eq[34][i].out;
		multi_or[8][i].in[3] <== eq[35][i].out;
		multi_or[8][i].in[4] <== eq[36][i].out;
		multi_or[8][i].in[5] <== eq[37][i].out;
		multi_or[8][i].in[6] <== eq[38][i].out;
		multi_or[8][i].in[7] <== eq[39][i].out;
		multi_or[8][i].in[8] <== eq[40][i].out;
		multi_or[8][i].in[9] <== eq[41][i].out;
		multi_or[8][i].in[10] <== eq[42][i].out;
		multi_or[8][i].in[11] <== eq[43][i].out;
		multi_or[8][i].in[12] <== eq[44][i].out;
		multi_or[8][i].in[13] <== eq[45][i].out;
		multi_or[8][i].in[14] <== eq[46][i].out;
		multi_or[8][i].in[15] <== eq[47][i].out;
		...
		multi_or[9][i].in[4] <== and[26][i].out;
		...
		multi_or[12][i].in[0] <== eq[50][i].out;
		multi_or[12][i].in[1] <== eq[51][i].out;
		multi_or[12][i].in[2] <== eq[52][i].out;
		and[31][i].b <== multi_or[12][i].out;
		and[32][i] = AND();
		and[32][i].a <== states[i][6];
		multi_or[13][i] = MultiOR(3);
		multi_or[13][i].in[0] <== eq[52][i].out;
		multi_or[13][i].in[1] <== eq[50][i].out;
		...
		states[i+1][12] <== multi_or[14][i].out;
		...
		multi_or[15][i].in[1] <== and[34][i].out;
	...
	// substrings calculated: [{(13, 9), (5, 7), (7, 6), (5, 6), (6, 11), (11, 9), (6, 6), (5, 8), (12, 9), (10, 7), (6, 7), (5, 12), (9, 7), (6, 8), (5, 13), (6, 9), (6, 13), (6, 12), (8, 7), (5, 10), (6, 10), (5, 9), (5, 11)}]
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][6] * states[i+2][6];
		is_substr0[i][10] <== is_substr0[i][9] + states[i+1][6] * states[i+2][7];
		is_substr0[i][11] <== is_substr0[i][10] + states[i+1][6] * states[i+2][8];
		is_substr0[i][12] <== is_substr0[i][11] + states[i+1][6] * states[i+2][9];
		is_substr0[i][13] <== is_substr0[i][12] + states[i+1][6] * states[i+2][10];
		is_substr0[i][14] <== is_substr0[i][13] + states[i+1][6] * states[i+2][11];
		is_substr0[i][15] <== is_substr0[i][14] + states[i+1][6] * states[i+2][12];
		is_substr0[i][16] <== is_substr0[i][15] + states[i+1][6] * states[i+2][13];
		is_substr0[i][17] <== is_substr0[i][16] + states[i+1][7] * states[i+2][6];
		is_substr0[i][18] <== is_substr0[i][17] + states[i+1][8] * states[i+2][7];
		is_substr0[i][19] <== is_substr0[i][18] + states[i+1][9] * states[i+2][7];
		is_substr0[i][20] <== is_substr0[i][19] + states[i+1][10] * states[i+2][7];
		is_substr0[i][21] <== is_substr0[i][20] + states[i+1][11] * states[i+2][9];
		is_substr0[i][22] <== is_substr0[i][21] + states[i+1][12] * states[i+2][9];
		is_substr0[i][23] <== is_substr0[i][22] + states[i+1][13] * states[i+2][9];
