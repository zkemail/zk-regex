...
template ToAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[10] <== eq[17][i].out;
		multi_or[2][i].in[11] <== eq[18][i].out;
		multi_or[2][i].in[12] <== eq[19][i].out;
		multi_or[2][i].in[13] <== eq[20][i].out;
		...
		multi_or[3][i].in[14] <== eq[35][i].out;
		multi_or[3][i].in[15] <== eq[36][i].out;
		...
		multi_or[10][i].in[1] <== eq[43][i].out;
		multi_or[10][i].in[2] <== eq[44][i].out;
		multi_or[10][i].in[3] <== eq[45][i].out;
		...
		multi_or[11][i].in[0] <== and[32][i].out;
		multi_or[11][i].in[1] <== and[33][i].out;
		multi_or[11][i].in[2] <== and[34][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		prev_states0[11][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][9];
		prev_states0[12][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][10];
		prev_states0[13][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][11];
		prev_states0[14][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][12];
		prev_states0[15][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		prev_states0[16][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		prev_states0[17][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		prev_states0[18][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		prev_states0[19][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		prev_states0[20][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		prev_states0[21][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		prev_states0[22][i] <== (1 - from_zero_enabled[i+1]) * states[i+1][13];
		is_substr0[i] <== MultiOR(23)([prev_states0[0][i] * states[i+2][6], prev_states0[1][i] * states[i+2][7], prev_states0[2][i] * states[i+2][8], prev_states0[3][i] * states[i+2][9], prev_states0[4][i] * states[i+2][10], prev_states0[5][i] * states[i+2][11], prev_states0[6][i] * states[i+2][12], prev_states0[7][i] * states[i+2][13], prev_states0[8][i] * states[i+2][13], prev_states0[9][i] * states[i+2][6], prev_states0[10][i] * states[i+2][6], prev_states0[11][i] * states[i+2][6], prev_states0[12][i] * states[i+2][8], prev_states0[13][i] * states[i+2][8], prev_states0[14][i] * states[i+2][8], prev_states0[15][i] * states[i+2][6], prev_states0[16][i] * states[i+2][7], prev_states0[17][i] * states[i+2][8], prev_states0[18][i] * states[i+2][9], prev_states0[19][i] * states[i+2][10], prev_states0[20][i] * states[i+2][11], prev_states0[21][i] * states[i+2][12], prev_states0[22][i] * states[i+2][13]]);
