...
template ToAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[3] <== and[9][i].out;
		multi_or[2][i].in[4] <== and[10][i].out;
		...
		multi_or[6][i].in[2] <== and[15][i].out;
		multi_or[6][i].in[3] <== and[16][i].out;
		multi_or[6][i].in[4] <== and[17][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i] <== MultiOR(23)([states[i+1][5] * states[i+2][6], states[i+1][5] * states[i+2][7], states[i+1][5] * states[i+2][8], states[i+1][5] * states[i+2][9], states[i+1][5] * states[i+2][10], states[i+1][5] * states[i+2][11], states[i+1][5] * states[i+2][12], states[i+1][5] * states[i+2][13], states[i+1][6] * states[i+2][13], states[i+1][7] * states[i+2][6], states[i+1][8] * states[i+2][6], states[i+1][9] * states[i+2][6], states[i+1][10] * states[i+2][8], states[i+1][11] * states[i+2][8], states[i+1][12] * states[i+2][8], states[i+1][13] * states[i+2][6], states[i+1][13] * states[i+2][7], states[i+1][13] * states[i+2][8], states[i+1][13] * states[i+2][9], states[i+1][13] * states[i+2][10], states[i+1][13] * states[i+2][11], states[i+1][13] * states[i+2][12], states[i+1][13] * states[i+2][13]]);
