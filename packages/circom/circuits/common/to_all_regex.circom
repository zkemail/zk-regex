...
template ToAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[11][i].in[10] <== eq[51][i].out;
		multi_or[11][i].in[11] <== eq[52][i].out;
		multi_or[11][i].in[12] <== eq[53][i].out;
		and[32][i].b <== multi_or[11][i].out;
		and[33][i] = AND();
		...
		multi_or[12][i].in[2] <== and[34][i].out;
	...
	// substrings calculated: [{(5, 6), (5, 7), (5, 8), (5, 9), (5, 10), (5, 11), (5, 12), (5, 13), (6, 13), (7, 6), (8, 6), (9, 6), (10, 8), (11, 8), (12, 8), (13, 6), (13, 7), (13, 8), (13, 9), (13, 10), (13, 11), (13, 12), (13, 13)}]
