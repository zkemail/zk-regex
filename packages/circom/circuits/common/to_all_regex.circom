...
template ToAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[9][i].in[2] <== and[23][i].out;
		multi_or[9][i].in[3] <== and[24][i].out;
		...
		states[i+1][13] <== multi_or[14][i].out;
	...
	// substrings calculated: [{(5, 10), (10, 7), (6, 9), (6, 11), (6, 7), (13, 9), (8, 7), (5, 6), (6, 8), (12, 9), (6, 10), (5, 9), (9, 7), (6, 12), (6, 6), (7, 6), (5, 7), (5, 11), (5, 13), (6, 13), (5, 8), (5, 12), (11, 9)}]
