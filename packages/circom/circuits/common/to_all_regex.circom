...
template ToAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[5][i].in[14] <== eq[33][i].out;
		multi_or[5][i].in[15] <== eq[34][i].out;
		and[25][i].b <== multi_or[5][i].out;
		and[26][i] = AND();
		and[26][i].a <== states[i][6];
		multi_or[6][i] = MultiOR(14);
		multi_or[6][i].in[0] <== eq[12][i].out;
		multi_or[6][i].in[1] <== eq[10][i].out;
		...
		multi_or[6][i].in[7] <== eq[15][i].out;
		multi_or[6][i].in[8] <== eq[14][i].out;
		multi_or[6][i].in[9] <== eq[5][i].out;
		multi_or[6][i].in[10] <== eq[13][i].out;
		multi_or[6][i].in[11] <== eq[18][i].out;
		multi_or[6][i].in[12] <== eq[8][i].out;
		multi_or[6][i].in[13] <== eq[7][i].out;
		and[26][i].b <== multi_or[6][i].out;
		multi_or[7][i] = MultiOR(5);
		multi_or[7][i].in[0] <== and[22][i].out;
		multi_or[7][i].in[1] <== and[23][i].out;
		multi_or[7][i].in[2] <== and[24][i].out;
		multi_or[7][i].in[3] <== and[25][i].out;
		multi_or[7][i].in[4] <== and[26][i].out;
		...
		multi_or[11][i].in[0] <== eq[38][i].out;
		...
		states[i+1][13] <== multi_or[13][i].out;
