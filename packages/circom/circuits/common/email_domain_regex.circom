...
template EmailDomainRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[10] <== eq[1][i].out;
		multi_or[1][i].in[11] <== eq[23][i].out;
		multi_or[1][i].in[12] <== eq[10][i].out;
		multi_or[1][i].in[13] <== eq[7][i].out;
		multi_or[1][i].in[14] <== eq[17][i].out;
		multi_or[1][i].in[15] <== eq[5][i].out;
		multi_or[1][i].in[16] <== eq[0][i].out;
		multi_or[1][i].in[17] <== eq[19][i].out;
		multi_or[1][i].in[18] <== eq[21][i].out;
		multi_or[1][i].in[19] <== eq[14][i].out;
		multi_or[1][i].in[20] <== eq[22][i].out;
		multi_or[1][i].in[21] <== eq[8][i].out;
		multi_or[1][i].in[22] <== eq[4][i].out;
		multi_or[1][i].in[23] <== eq[6][i].out;
		multi_or[1][i].in[24] <== eq[2][i].out;
		multi_or[1][i].in[25] <== eq[20][i].out;
		multi_or[1][i].in[26] <== eq[13][i].out;
