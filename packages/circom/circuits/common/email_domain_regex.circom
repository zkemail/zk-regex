...
template EmailDomainRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[7] <== eq[24][i].out;
		multi_or[1][i].in[8] <== eq[8][i].out;
		multi_or[1][i].in[9] <== eq[2][i].out;
		multi_or[1][i].in[10] <== eq[16][i].out;
		multi_or[1][i].in[11] <== eq[7][i].out;
		multi_or[1][i].in[12] <== eq[22][i].out;
		multi_or[1][i].in[13] <== eq[0][i].out;
		multi_or[1][i].in[14] <== eq[3][i].out;
		multi_or[1][i].in[15] <== eq[20][i].out;
		multi_or[1][i].in[16] <== eq[23][i].out;
		multi_or[1][i].in[17] <== eq[21][i].out;
		multi_or[1][i].in[18] <== eq[9][i].out;
		multi_or[1][i].in[19] <== eq[18][i].out;
		multi_or[1][i].in[20] <== eq[17][i].out;
		multi_or[1][i].in[21] <== eq[13][i].out;
		multi_or[1][i].in[22] <== eq[1][i].out;
		multi_or[1][i].in[23] <== eq[11][i].out;
		multi_or[1][i].in[24] <== eq[12][i].out;
		multi_or[1][i].in[25] <== eq[5][i].out;
		...
		multi_or[4][i].in[4] <== eq[15][i].out;
		multi_or[4][i].in[5] <== eq[0][i].out;
		multi_or[4][i].in[6] <== eq[24][i].out;
		multi_or[4][i].in[7] <== eq[20][i].out;
		multi_or[4][i].in[8] <== eq[14][i].out;
		multi_or[4][i].in[9] <== eq[18][i].out;
		multi_or[4][i].in[10] <== eq[13][i].out;
		multi_or[4][i].in[11] <== eq[16][i].out;
		multi_or[4][i].in[12] <== eq[2][i].out;
