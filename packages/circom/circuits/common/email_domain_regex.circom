...
template EmailDomainRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[18] <== eq[1][i].out;
		multi_or[1][i].in[19] <== eq[12][i].out;
		multi_or[1][i].in[20] <== eq[3][i].out;
		multi_or[1][i].in[21] <== eq[11][i].out;
		multi_or[1][i].in[22] <== eq[13][i].out;
		multi_or[1][i].in[23] <== eq[14][i].out;
		multi_or[1][i].in[24] <== eq[20][i].out;
		multi_or[1][i].in[25] <== eq[6][i].out;
		multi_or[1][i].in[26] <== eq[8][i].out;
		...
		multi_or[4][i].in[10] <== eq[19][i].out;
