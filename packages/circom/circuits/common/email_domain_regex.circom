...
template EmailDomainRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[15] <== eq[17][i].out;
		multi_or[1][i].in[16] <== eq[11][i].out;
		multi_or[1][i].in[17] <== eq[10][i].out;
		multi_or[1][i].in[18] <== eq[5][i].out;
		multi_or[1][i].in[19] <== eq[7][i].out;
		multi_or[1][i].in[20] <== eq[9][i].out;
		multi_or[1][i].in[21] <== eq[4][i].out;
		multi_or[1][i].in[22] <== eq[12][i].out;
		multi_or[1][i].in[23] <== eq[16][i].out;
		multi_or[1][i].in[24] <== eq[19][i].out;
		multi_or[1][i].in[25] <== eq[3][i].out;
		multi_or[1][i].in[26] <== eq[0][i].out;
		...
		multi_or[4][i].in[5] <== eq[16][i].out;
		multi_or[4][i].in[6] <== eq[8][i].out;
		multi_or[4][i].in[7] <== eq[10][i].out;
		multi_or[4][i].in[8] <== eq[6][i].out;
		multi_or[4][i].in[9] <== eq[14][i].out;
		multi_or[4][i].in[10] <== eq[5][i].out;
		multi_or[4][i].in[11] <== eq[3][i].out;
