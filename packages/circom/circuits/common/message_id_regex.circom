...
template MessageIdRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		eq[29][i].in[1] <== 95;
		and[5][i] = AND();
		and[5][i].a <== states[i][18];
		multi_or[1][i] = MultiOR(17);
		multi_or[1][i].in[0] <== and[3][i].out;
		multi_or[1][i].in[1] <== and[4][i].out;
		multi_or[1][i].in[2] <== eq[15][i].out;
		multi_or[1][i].in[3] <== eq[16][i].out;
		multi_or[1][i].in[4] <== eq[17][i].out;
		multi_or[1][i].in[5] <== eq[18][i].out;
		multi_or[1][i].in[6] <== eq[19][i].out;
		multi_or[1][i].in[7] <== eq[20][i].out;
		multi_or[1][i].in[8] <== eq[21][i].out;
		multi_or[1][i].in[9] <== eq[22][i].out;
		multi_or[1][i].in[10] <== eq[23][i].out;
		multi_or[1][i].in[11] <== eq[24][i].out;
		multi_or[1][i].in[12] <== eq[25][i].out;
		multi_or[1][i].in[13] <== eq[26][i].out;
		multi_or[1][i].in[14] <== eq[27][i].out;
		multi_or[1][i].in[15] <== eq[28][i].out;
		multi_or[1][i].in[16] <== eq[29][i].out;
		...
		and[6][i].b <== eq[30][i].out;
		eq[31][i] = IsEqual();
		eq[31][i].in[0] <== in[i];
		eq[31][i].in[1] <== 13;
		and[7][i] = AND();
		and[7][i].a <== states[i][3];
		and[7][i].b <== eq[31][i].out;
		...
		and[8][i].b <== eq[32][i].out;
		eq[33][i] = IsEqual();
		eq[33][i].in[0] <== in[i];
		eq[33][i].in[1] <== 10;
		and[9][i] = AND();
		and[9][i].a <== states[i][2];
		and[9][i].b <== eq[33][i].out;
