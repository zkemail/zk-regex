...
template MessageIdRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[11] <== eq[20][i].out;
		multi_or[0][i].in[12] <== eq[21][i].out;
		multi_or[0][i].in[13] <== eq[22][i].out;
		multi_or[0][i].in[14] <== eq[23][i].out;
		multi_or[0][i].in[15] <== eq[24][i].out;
		multi_or[0][i].in[16] <== eq[25][i].out;
