...
template EmailAddrWithNameRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[10][i].in[2] <== and[22][i].out;
		multi_or[10][i].in[3] <== and[23][i].out;
		multi_or[10][i].in[4] <== and[24][i].out;
		multi_or[10][i].in[5] <== and[25][i].out;
		...
		multi_or[11][i] = MultiOR(25);
		multi_or[11][i].in[0] <== and[15][i].out;
		multi_or[11][i].in[1] <== and[26][i].out;
		multi_or[11][i].in[2] <== eq[43][i].out;
		multi_or[11][i].in[3] <== eq[44][i].out;
		multi_or[11][i].in[4] <== eq[45][i].out;
		multi_or[11][i].in[5] <== eq[46][i].out;
		multi_or[11][i].in[6] <== eq[47][i].out;
		multi_or[11][i].in[7] <== eq[48][i].out;
		multi_or[11][i].in[8] <== eq[49][i].out;
		multi_or[11][i].in[9] <== eq[50][i].out;
		multi_or[11][i].in[10] <== eq[29][i].out;
		multi_or[11][i].in[11] <== eq[30][i].out;
		multi_or[11][i].in[12] <== eq[13][i].out;
		multi_or[11][i].in[13] <== eq[31][i].out;
		multi_or[11][i].in[14] <== eq[32][i].out;
		multi_or[11][i].in[15] <== eq[33][i].out;
		multi_or[11][i].in[16] <== eq[34][i].out;
		multi_or[11][i].in[17] <== eq[35][i].out;
		multi_or[11][i].in[18] <== eq[36][i].out;
		multi_or[11][i].in[19] <== eq[37][i].out;
		multi_or[11][i].in[20] <== eq[38][i].out;
		multi_or[11][i].in[21] <== eq[39][i].out;
		multi_or[11][i].in[22] <== eq[40][i].out;
		multi_or[11][i].in[23] <== eq[16][i].out;
		multi_or[11][i].in[24] <== eq[17][i].out;
		and[27][i].b <== multi_or[11][i].out;
		and[28][i] = AND();
		and[28][i].a <== states[i][5];
		and[28][i].b <== multi_or[11][i].out;
		multi_or[12][i] = MultiOR(2);
		multi_or[12][i].in[0] <== and[27][i].out;
		multi_or[12][i].in[1] <== and[28][i].out;
