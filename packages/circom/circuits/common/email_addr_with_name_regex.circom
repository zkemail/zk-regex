...
template EmailAddrWithNameRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		and[36][i] = AND();
		and[36][i].a <== states[i][1];
		and[36][i].b <== and[4][i].out;
		...
		multi_or[12][i].in[1] <== eq[45][i].out;
		multi_or[12][i].in[2] <== eq[46][i].out;
		multi_or[12][i].in[3] <== eq[47][i].out;
		multi_or[12][i].in[4] <== eq[48][i].out;
		multi_or[12][i].in[5] <== eq[49][i].out;
		multi_or[12][i].in[6] <== eq[50][i].out;
		multi_or[12][i].in[7] <== eq[51][i].out;
		multi_or[12][i].in[8] <== eq[52][i].out;
		multi_or[12][i].in[9] <== eq[53][i].out;
		multi_or[12][i].in[10] <== eq[54][i].out;
		multi_or[12][i].in[11] <== eq[55][i].out;
		multi_or[12][i].in[12] <== eq[56][i].out;
		...
		multi_or[13][i].in[13] <== eq[57][i].out;
		multi_or[13][i].in[14] <== eq[58][i].out;
		multi_or[13][i].in[15] <== eq[59][i].out;
		...
		multi_or[16][i].in[25] <== eq[83][i].out;
		...
		multi_or[18][i].in[2] <== eq[69][i].out;
		multi_or[18][i].in[3] <== eq[70][i].out;
		multi_or[18][i].in[4] <== eq[72][i].out;
		multi_or[18][i].in[5] <== eq[73][i].out;
		multi_or[18][i].in[6] <== eq[74][i].out;
		multi_or[18][i].in[7] <== eq[75][i].out;
		multi_or[18][i].in[8] <== eq[76][i].out;
		multi_or[18][i].in[9] <== eq[77][i].out;
		multi_or[18][i].in[10] <== eq[78][i].out;
		multi_or[18][i].in[11] <== eq[79][i].out;
		multi_or[18][i].in[12] <== eq[80][i].out;
		multi_or[18][i].in[13] <== eq[81][i].out;
		multi_or[18][i].in[14] <== eq[84][i].out;
		...
		states[i+1][8] <== MultiOR(2)([states_tmp[i+1][8], from_zero_enabled[i] * and[35][i].out]);
