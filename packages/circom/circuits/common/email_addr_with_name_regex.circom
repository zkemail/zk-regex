...
template EmailAddrWithNameRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[24] <== eq[23][i].out;
		...
		multi_or[6][i].in[0] <== eq[25][i].out;
		multi_or[6][i].in[1] <== eq[26][i].out;
		multi_or[6][i].in[2] <== eq[27][i].out;
		multi_or[6][i].in[3] <== eq[28][i].out;
		multi_or[6][i].in[4] <== eq[29][i].out;
		multi_or[6][i].in[5] <== eq[30][i].out;
		multi_or[6][i].in[6] <== eq[31][i].out;
		multi_or[6][i].in[7] <== eq[32][i].out;
		multi_or[6][i].in[8] <== eq[33][i].out;
		multi_or[6][i].in[9] <== eq[34][i].out;
		multi_or[6][i].in[10] <== eq[35][i].out;
		multi_or[6][i].in[11] <== eq[36][i].out;
		multi_or[6][i].in[12] <== eq[37][i].out;
		multi_or[6][i].in[13] <== eq[38][i].out;
		...
		multi_or[7][i].in[14] <== eq[53][i].out;
		multi_or[7][i].in[15] <== eq[54][i].out;
		...
		and[28][i].b <== eq[55][i].out;
		and[29][i] = AND();
		and[29][i].a <== states[i][1];
		and[29][i].b <== eq[55][i].out;
		and[30][i] = AND();
		and[30][i].a <== states[i][9];
		and[30][i].b <== eq[55][i].out;
		...
		and[31][i].b <== eq[56][i].out;
		and[32][i] = AND();
		and[32][i].a <== states[i][1];
		and[32][i].b <== eq[56][i].out;
		and[33][i] = AND();
		and[33][i].a <== states[i][9];
		and[33][i].b <== eq[56][i].out;
		...
		multi_or[11][i].in[0] <== eq[57][i].out;
		multi_or[11][i].in[1] <== eq[58][i].out;
		multi_or[11][i].in[2] <== eq[59][i].out;
		...
		and[37][i].b <== eq[60][i].out;
		and[38][i] = AND();
		and[38][i].a <== states[i][1];
		and[38][i].b <== eq[60][i].out;
		and[39][i] = AND();
		and[39][i].a <== states[i][9];
		and[39][i].b <== eq[60][i].out;
		...
		multi_or[15][i].in[2] <== eq[62][i].out;
		multi_or[15][i].in[3] <== eq[63][i].out;
		multi_or[15][i].in[4] <== eq[64][i].out;
		multi_or[15][i].in[5] <== eq[65][i].out;
		multi_or[15][i].in[6] <== eq[66][i].out;
		multi_or[15][i].in[7] <== eq[67][i].out;
		multi_or[15][i].in[8] <== eq[68][i].out;
		multi_or[15][i].in[9] <== eq[69][i].out;
		multi_or[15][i].in[10] <== eq[70][i].out;
		multi_or[15][i].in[11] <== eq[71][i].out;
		multi_or[15][i].in[12] <== eq[72][i].out;
		multi_or[15][i].in[13] <== eq[73][i].out;
		multi_or[15][i].in[14] <== eq[74][i].out;
		multi_or[15][i].in[15] <== eq[75][i].out;
		multi_or[15][i].in[16] <== eq[76][i].out;
		multi_or[15][i].in[17] <== eq[77][i].out;
		multi_or[15][i].in[18] <== eq[78][i].out;
		multi_or[15][i].in[19] <== eq[79][i].out;
		multi_or[15][i].in[20] <== eq[80][i].out;
		multi_or[15][i].in[21] <== eq[81][i].out;
		multi_or[15][i].in[22] <== eq[82][i].out;
		multi_or[15][i].in[23] <== eq[83][i].out;
