...
template EmailAddrWithNameRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[5][i].in[10] <== eq[46][i].out;
		multi_or[5][i].in[11] <== eq[47][i].out;
		multi_or[5][i].in[12] <== eq[48][i].out;
		and[26][i].b <== multi_or[5][i].out;
		and[27][i] = AND();
		and[27][i].a <== states[i][1];
		and[27][i].b <== and[4][i].out;
		and[28][i] = AND();
		...
		states_tmp[i+1][8] <== multi_or[6][i].out;
		eq[49][i] = IsEqual();
		eq[49][i].in[0] <== in[i];
		eq[49][i].in[1] <== 60;
		and[29][i] = AND();
		...
		lt[13][i].in[1] <== 90;
		and[30][i] = AND();
		and[30][i].a <== lt[12][i].out;
		and[30][i].b <== lt[13][i].out;
		...
		lt[15][i].in[1] <== 126;
		and[31][i] = AND();
		and[31][i].a <== lt[14][i].out;
		and[31][i].b <== lt[15][i].out;
		eq[50][i] = IsEqual();
		eq[50][i].in[0] <== in[i];
		eq[50][i].in[1] <== 33;
		eq[51][i] = IsEqual();
		...
		multi_or[7][i].in[2] <== eq[50][i].out;
		multi_or[7][i].in[3] <== eq[51][i].out;
		multi_or[7][i].in[4] <== eq[52][i].out;
		multi_or[7][i].in[5] <== eq[53][i].out;
		multi_or[7][i].in[6] <== eq[54][i].out;
		multi_or[7][i].in[7] <== eq[55][i].out;
		multi_or[7][i].in[8] <== eq[56][i].out;
		multi_or[7][i].in[9] <== eq[57][i].out;
		multi_or[7][i].in[10] <== eq[58][i].out;
		multi_or[7][i].in[11] <== eq[59][i].out;
		multi_or[7][i].in[12] <== eq[60][i].out;
		multi_or[7][i].in[13] <== eq[61][i].out;
		multi_or[7][i].in[14] <== eq[62][i].out;
		multi_or[7][i].in[15] <== eq[63][i].out;
		multi_or[7][i].in[16] <== eq[64][i].out;
		multi_or[7][i].in[17] <== eq[65][i].out;
		multi_or[7][i].in[18] <== eq[66][i].out;
		multi_or[7][i].in[19] <== eq[67][i].out;
		multi_or[7][i].in[20] <== eq[68][i].out;
		multi_or[7][i].in[21] <== eq[69][i].out;
		multi_or[7][i].in[22] <== eq[70][i].out;
		multi_or[7][i].in[23] <== eq[71][i].out;
		multi_or[7][i].in[24] <== eq[72][i].out;
		multi_or[7][i].in[25] <== eq[73][i].out;
		...
		multi_or[9][i].in[2] <== eq[59][i].out;
		multi_or[9][i].in[3] <== eq[60][i].out;
		multi_or[9][i].in[4] <== eq[62][i].out;
		multi_or[9][i].in[5] <== eq[63][i].out;
		multi_or[9][i].in[6] <== eq[64][i].out;
		multi_or[9][i].in[7] <== eq[65][i].out;
		multi_or[9][i].in[8] <== eq[66][i].out;
		multi_or[9][i].in[9] <== eq[67][i].out;
		multi_or[9][i].in[10] <== eq[68][i].out;
		multi_or[9][i].in[11] <== eq[69][i].out;
		multi_or[9][i].in[12] <== eq[70][i].out;
		multi_or[9][i].in[13] <== eq[71][i].out;
		multi_or[9][i].in[14] <== eq[75][i].out;
		...
		states[i+1][8] <== MultiOR(2)([states_tmp[i+1][8], from_zero_enabled[i] * and[26][i].out]);
