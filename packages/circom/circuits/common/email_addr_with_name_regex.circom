...
template EmailAddrWithNameRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[7][i].in[4] <== eq[22][i].out;
		multi_or[7][i].in[5] <== eq[23][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][5] * states[i+2][5];
