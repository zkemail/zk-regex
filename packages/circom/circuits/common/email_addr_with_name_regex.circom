...
template EmailAddrWithNameRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[13] <== eq[10][i].out;
		multi_or[0][i].in[14] <== eq[11][i].out;
		multi_or[0][i].in[15] <== eq[12][i].out;
		...
		lt[13][i].in[1] <== 93;
		and[7][i] = AND();
		and[7][i].a <== lt[12][i].out;
		and[7][i].b <== lt[13][i].out;
		...
		lt[15][i].in[1] <== 254;
		and[8][i] = AND();
		and[8][i].a <== lt[14][i].out;
		and[8][i].b <== lt[15][i].out;
		eq[13][i] = IsEqual();
		eq[13][i].in[0] <== in[i];
		eq[13][i].in[1] <== 0;
		eq[14][i] = IsEqual();
		...
		lt[19][i].in[1] <== 122;
		and[11][i] = AND();
		and[11][i].a <== lt[18][i].out;
		and[11][i].b <== lt[19][i].out;
		eq[25][i] = IsEqual();
		eq[25][i].in[0] <== in[i];
		eq[25][i].in[1] <== 45;
		eq[26][i] = IsEqual();
		...
		lt[21][i].in[1] <== 90;
		and[13][i] = AND();
		and[13][i].a <== lt[20][i].out;
		and[13][i].b <== lt[21][i].out;
		...
		lt[23][i].in[1] <== 122;
		and[14][i] = AND();
		and[14][i].a <== lt[22][i].out;
		and[14][i].b <== lt[23][i].out;
		eq[38][i] = IsEqual();
		eq[38][i].in[0] <== in[i];
		eq[38][i].in[1] <== 45;
		eq[39][i] = IsEqual();
		...
		multi_or[4][i].in[2] <== eq[38][i].out;
		multi_or[4][i].in[3] <== eq[39][i].out;
		multi_or[4][i].in[4] <== eq[40][i].out;
		multi_or[4][i].in[5] <== eq[41][i].out;
		multi_or[4][i].in[6] <== eq[42][i].out;
		multi_or[4][i].in[7] <== eq[43][i].out;
		multi_or[4][i].in[8] <== eq[44][i].out;
		multi_or[4][i].in[9] <== eq[45][i].out;
		multi_or[4][i].in[10] <== eq[46][i].out;
		multi_or[4][i].in[11] <== eq[47][i].out;
		multi_or[4][i].in[12] <== eq[48][i].out;
		multi_or[4][i].in[13] <== eq[49][i].out;
		multi_or[4][i].in[14] <== eq[50][i].out;
		...
		multi_or[6][i].in[2] <== eq[53][i].out;
		multi_or[6][i].in[3] <== eq[54][i].out;
		multi_or[6][i].in[4] <== eq[55][i].out;
		multi_or[6][i].in[5] <== eq[56][i].out;
		multi_or[6][i].in[6] <== eq[57][i].out;
		multi_or[6][i].in[7] <== eq[58][i].out;
		multi_or[6][i].in[8] <== eq[59][i].out;
		multi_or[6][i].in[9] <== eq[60][i].out;
		multi_or[6][i].in[10] <== eq[61][i].out;
		multi_or[6][i].in[11] <== eq[62][i].out;
		multi_or[6][i].in[12] <== eq[63][i].out;
		multi_or[6][i].in[13] <== eq[64][i].out;
		multi_or[6][i].in[14] <== eq[65][i].out;
		...
		multi_or[7][i].in[2] <== eq[66][i].out;
		multi_or[7][i].in[3] <== eq[67][i].out;
		multi_or[7][i].in[4] <== eq[68][i].out;
		multi_or[7][i].in[5] <== eq[69][i].out;
		multi_or[7][i].in[6] <== eq[70][i].out;
		multi_or[7][i].in[7] <== eq[71][i].out;
		multi_or[7][i].in[8] <== eq[72][i].out;
		multi_or[7][i].in[9] <== eq[73][i].out;
		multi_or[7][i].in[10] <== eq[74][i].out;
		multi_or[7][i].in[11] <== eq[75][i].out;
		multi_or[7][i].in[12] <== eq[76][i].out;
		multi_or[7][i].in[13] <== eq[77][i].out;
		multi_or[7][i].in[14] <== eq[78][i].out;
		and[23][i].b <== multi_or[7][i].out;
		multi_or[8][i] = MultiOR(2);
		multi_or[8][i].in[0] <== and[20][i].out;
		multi_or[8][i].in[1] <== and[23][i].out;
		states[i+1][5] <== multi_or[8][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][4] * states[i+2][5];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][5] * states[i+2][5];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][5] * states[i+2][6];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][6] * states[i+2][2];
