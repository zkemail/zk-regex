...
template EmailAddrRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[23] <== eq[24][i].out;
		multi_or[1][i].in[24] <== eq[25][i].out;
		multi_or[1][i].in[25] <== eq[26][i].out;
		multi_or[1][i].in[26] <== eq[27][i].out;
		multi_or[1][i].in[27] <== eq[28][i].out;
		multi_or[1][i].in[28] <== eq[29][i].out;
		multi_or[1][i].in[29] <== eq[30][i].out;
		multi_or[1][i].in[30] <== eq[31][i].out;
		multi_or[1][i].in[31] <== eq[32][i].out;
		multi_or[1][i].in[32] <== eq[33][i].out;
		multi_or[1][i].in[33] <== eq[34][i].out;
		multi_or[1][i].in[34] <== eq[35][i].out;
		multi_or[1][i].in[35] <== eq[36][i].out;
		multi_or[1][i].in[36] <== eq[37][i].out;
		multi_or[1][i].in[37] <== eq[38][i].out;
		multi_or[1][i].in[38] <== eq[39][i].out;
		multi_or[1][i].in[39] <== eq[40][i].out;
		multi_or[1][i].in[40] <== eq[41][i].out;
		multi_or[1][i].in[41] <== eq[42][i].out;
		multi_or[1][i].in[42] <== eq[43][i].out;
		multi_or[1][i].in[43] <== eq[44][i].out;
		multi_or[1][i].in[44] <== eq[45][i].out;
		multi_or[1][i].in[45] <== eq[46][i].out;
		multi_or[1][i].in[46] <== eq[47][i].out;
		multi_or[1][i].in[47] <== eq[48][i].out;
		multi_or[1][i].in[48] <== eq[49][i].out;
		multi_or[1][i].in[49] <== eq[50][i].out;
		multi_or[1][i].in[50] <== eq[51][i].out;
		multi_or[1][i].in[51] <== eq[52][i].out;
		multi_or[1][i].in[52] <== eq[53][i].out;
		multi_or[1][i].in[53] <== eq[54][i].out;
		multi_or[1][i].in[54] <== eq[55][i].out;
		multi_or[1][i].in[55] <== eq[56][i].out;
		multi_or[1][i].in[56] <== eq[57][i].out;
		multi_or[1][i].in[57] <== eq[58][i].out;
		multi_or[1][i].in[58] <== eq[59][i].out;
		multi_or[1][i].in[59] <== eq[60][i].out;
		multi_or[1][i].in[60] <== eq[61][i].out;
		multi_or[1][i].in[61] <== eq[62][i].out;
		multi_or[1][i].in[62] <== eq[63][i].out;
		multi_or[1][i].in[63] <== eq[64][i].out;
		multi_or[1][i].in[64] <== eq[65][i].out;
		multi_or[1][i].in[65] <== eq[66][i].out;
		multi_or[1][i].in[66] <== eq[67][i].out;
		multi_or[1][i].in[67] <== eq[68][i].out;
		multi_or[1][i].in[68] <== eq[69][i].out;
		multi_or[1][i].in[69] <== eq[70][i].out;
		multi_or[1][i].in[70] <== eq[71][i].out;
		multi_or[1][i].in[71] <== eq[72][i].out;
		multi_or[1][i].in[72] <== eq[73][i].out;
		multi_or[1][i].in[73] <== eq[74][i].out;
		multi_or[1][i].in[74] <== eq[75][i].out;
		multi_or[1][i].in[75] <== eq[76][i].out;
		multi_or[1][i].in[76] <== eq[77][i].out;
		multi_or[1][i].in[77] <== eq[78][i].out;
		multi_or[1][i].in[78] <== eq[79][i].out;
		multi_or[1][i].in[79] <== eq[80][i].out;
		multi_or[1][i].in[80] <== eq[81][i].out;
		multi_or[1][i].in[81] <== eq[82][i].out;
