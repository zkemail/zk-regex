...
template EmailAddrRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[15] <== eq[6][i].out;
		multi_or[1][i].in[16] <== eq[20][i].out;
		...
		multi_or[4][i].in[6] <== eq[19][i].out;
		multi_or[4][i].in[7] <== eq[5][i].out;
		multi_or[4][i].in[8] <== eq[3][i].out;
		multi_or[4][i].in[9] <== eq[17][i].out;
		multi_or[4][i].in[10] <== eq[23][i].out;
		multi_or[4][i].in[11] <== eq[7][i].out;
		multi_or[4][i].in[12] <== eq[15][i].out;
		multi_or[4][i].in[13] <== eq[0][i].out;
	...
	// substrings calculated: [{(3, 3), (0, 1), (1, 2), (1, 1), (2, 3)}]
