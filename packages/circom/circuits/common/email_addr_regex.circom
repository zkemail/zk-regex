...
template EmailAddrRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[12] <== eq[7][i].out;
		multi_or[1][i].in[13] <== eq[2][i].out;
		...
		multi_or[1][i].in[20] <== eq[6][i].out;
		multi_or[1][i].in[21] <== eq[18][i].out;
		multi_or[1][i].in[22] <== eq[0][i].out;
	...
	// substrings calculated: [{(1, 2), (1, 1), (0, 1), (2, 3), (3, 3)}]
