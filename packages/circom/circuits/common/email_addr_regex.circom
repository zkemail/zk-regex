...
template EmailAddrRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[3][i].in[7] <== eq[3][i].out;
		multi_or[3][i].in[8] <== eq[5][i].out;
		multi_or[3][i].in[9] <== eq[6][i].out;
		multi_or[3][i].in[10] <== eq[12][i].out;
		...
		multi_or[5][i].in[3] <== and[14][i].out;
		multi_or[5][i].in[4] <== and[16][i].out;
		...
		multi_or[8][i].in[0] <== eq[33][i].out;
		multi_or[8][i].in[1] <== eq[34][i].out;
		multi_or[8][i].in[2] <== eq[35][i].out;
		...
		lt[13][i].in[1] <== 120;
		and[27][i] = AND();
		and[27][i].a <== lt[12][i].out;
		and[27][i].b <== lt[13][i].out;
		eq[37][i] = IsEqual();
		eq[37][i].in[0] <== in[i];
		eq[37][i].in[1] <== 255;
		eq[38][i] = IsEqual();
		...
		multi_or[11][i].in[0] <== and[26][i].out;
		...
		multi_or[13][i].in[0] <== and[25][i].out;
		multi_or[13][i].in[1] <== and[28][i].out;
		multi_or[13][i].in[2] <== and[29][i].out;
		states[i+1][8] <== multi_or[13][i].out;
