...
template EmailAddrRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[3][i].in[5] <== eq[23][i].out;
		multi_or[3][i].in[6] <== eq[16][i].out;
		multi_or[3][i].in[7] <== eq[0][i].out;
		multi_or[3][i].in[8] <== eq[7][i].out;
		multi_or[3][i].in[9] <== eq[2][i].out;
		multi_or[3][i].in[10] <== eq[1][i].out;
		multi_or[3][i].in[11] <== eq[4][i].out;
		multi_or[3][i].in[12] <== eq[15][i].out;
	...
	// substrings calculated: [{(2, 3), (3, 3), (0, 1), (1, 2), (1, 1)}]
