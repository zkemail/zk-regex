...
template EmailAddrRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[23] <== eq[15][i].out;
	...
	// substrings calculated: [{(2, 3), (1, 2), (1, 1), (0, 1), (3, 3)}]
