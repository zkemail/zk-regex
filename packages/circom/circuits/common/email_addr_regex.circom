...
template EmailAddrRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[9] <== eq[3][i].out;
		multi_or[1][i].in[10] <== eq[9][i].out;
		multi_or[1][i].in[11] <== eq[1][i].out;
		multi_or[1][i].in[12] <== eq[6][i].out;
		multi_or[1][i].in[13] <== eq[15][i].out;
		multi_or[1][i].in[14] <== eq[4][i].out;
		multi_or[1][i].in[15] <== eq[13][i].out;
		multi_or[1][i].in[16] <== eq[8][i].out;
		multi_or[1][i].in[17] <== eq[12][i].out;
		multi_or[1][i].in[18] <== eq[18][i].out;
		multi_or[1][i].in[19] <== eq[5][i].out;
		multi_or[1][i].in[20] <== eq[21][i].out;
		multi_or[1][i].in[21] <== eq[7][i].out;
		multi_or[1][i].in[22] <== eq[19][i].out;
