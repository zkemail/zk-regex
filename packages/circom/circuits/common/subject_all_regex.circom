...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[7][i].in[3] <== eq[32][i].out;
		multi_or[7][i].in[4] <== eq[23][i].out;
		multi_or[7][i].in[5] <== eq[28][i].out;
		multi_or[7][i].in[6] <== eq[36][i].out;
		multi_or[7][i].in[7] <== eq[35][i].out;
		multi_or[7][i].in[8] <== eq[27][i].out;
		multi_or[7][i].in[9] <== eq[25][i].out;
		multi_or[7][i].in[10] <== eq[31][i].out;
		multi_or[7][i].in[11] <== eq[24][i].out;
		multi_or[7][i].in[12] <== eq[34][i].out;
		multi_or[7][i].in[13] <== eq[30][i].out;
		and[27][i].b <== multi_or[7][i].out;
		and[28][i] = AND();
		and[28][i].a <== states[i][17];
		and[28][i].b <== and[13][i].out;
		...
		multi_or[13][i].in[0] <== eq[56][i].out;
		...
		states[i+1][17] <== multi_or[14][i].out;
		...
		multi_or[15][i].in[0] <== and[38][i].out;
		multi_or[15][i].in[1] <== and[39][i].out;
	...
	// substrings calculated: [{(11, 14), (10, 11), (11, 13), (17, 14), (11, 12), (18, 14), (10, 18), (10, 13), (12, 11), (10, 12), (11, 18), (10, 15), (11, 11), (14, 12), (10, 17), (10, 16), (16, 14), (13, 12), (10, 14), (11, 17), (15, 12), (11, 16), (11, 15)}]
