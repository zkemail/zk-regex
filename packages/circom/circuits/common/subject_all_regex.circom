...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[1] <== and[14][i].out;
		multi_or[0][i].in[2] <== and[16][i].out;
		multi_or[0][i].in[3] <== and[18][i].out;
		multi_or[0][i].in[4] <== and[19][i].out;
		states[i+1][11] <== multi_or[0][i].out;
		eq[10][i] = IsEqual();
		eq[10][i].in[0] <== in[i];
		eq[10][i].in[1] <== 224;
		and[20][i] = AND();
		...
		multi_or[1][i].in[1] <== and[21][i].out;
		...
		multi_or[2][i].in[13] <== eq[24][i].out;
		...
		multi_or[3][i].in[4] <== eq[29][i].out;
		multi_or[3][i].in[5] <== eq[30][i].out;
		multi_or[3][i].in[6] <== eq[31][i].out;
		multi_or[3][i].in[7] <== eq[32][i].out;
		multi_or[3][i].in[8] <== eq[33][i].out;
		multi_or[3][i].in[9] <== eq[34][i].out;
		multi_or[3][i].in[10] <== eq[35][i].out;
		multi_or[3][i].in[11] <== eq[36][i].out;
		multi_or[3][i].in[12] <== eq[37][i].out;
		multi_or[3][i].in[13] <== eq[38][i].out;
		multi_or[3][i].in[14] <== eq[39][i].out;
		multi_or[3][i].in[15] <== eq[40][i].out;
		and[26][i].b <== multi_or[3][i].out;
		and[27][i] = AND();
		and[27][i].a <== states[i][18];
		and[27][i].b <== multi_or[2][i].out;
		multi_or[4][i] = MultiOR(5);
		multi_or[4][i].in[0] <== and[22][i].out;
		multi_or[4][i].in[1] <== and[24][i].out;
		multi_or[4][i].in[2] <== and[25][i].out;
		multi_or[4][i].in[3] <== and[26][i].out;
		multi_or[4][i].in[4] <== and[27][i].out;
		...
		states[i+1][15] <== multi_or[6][i].out;
		eq[43][i] = IsEqual();
		eq[43][i].in[0] <== in[i];
		eq[43][i].in[1] <== 241;
		eq[44][i] = IsEqual();
		...
		multi_or[7][i].in[0] <== eq[43][i].out;
		multi_or[7][i].in[1] <== eq[44][i].out;
		multi_or[7][i].in[2] <== eq[45][i].out;
		and[32][i].b <== multi_or[7][i].out;
		and[33][i] = AND();
		and[33][i].a <== states[i][18];
		and[33][i].b <== multi_or[7][i].out;
		multi_or[8][i] = MultiOR(2);
		multi_or[8][i].in[0] <== and[32][i].out;
		...
		states[i+1][17] <== multi_or[9][i].out;
		...
		multi_or[10][i].in[1] <== eq[47][i].out;
		multi_or[10][i].in[2] <== eq[48][i].out;
		multi_or[10][i].in[3] <== eq[49][i].out;
		multi_or[10][i].in[4] <== eq[50][i].out;
		multi_or[10][i].in[5] <== eq[51][i].out;
		multi_or[10][i].in[6] <== eq[52][i].out;
		multi_or[10][i].in[7] <== eq[53][i].out;
		multi_or[10][i].in[8] <== eq[54][i].out;
		multi_or[10][i].in[9] <== eq[55][i].out;
		multi_or[10][i].in[10] <== eq[56][i].out;
		multi_or[10][i].in[11] <== eq[57][i].out;
		multi_or[10][i].in[12] <== eq[58][i].out;
		...
		multi_or[11][i].in[0] <== and[37][i].out;
		multi_or[11][i].in[1] <== and[38][i].out;
		multi_or[11][i].in[2] <== and[39][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i] <== MultiOR(23)([states[i+1][10] * states[i+2][11], states[i+1][10] * states[i+2][12], states[i+1][10] * states[i+2][13], states[i+1][10] * states[i+2][14], states[i+1][10] * states[i+2][15], states[i+1][10] * states[i+2][16], states[i+1][10] * states[i+2][17], states[i+1][10] * states[i+2][18], states[i+1][11] * states[i+2][18], states[i+1][12] * states[i+2][11], states[i+1][13] * states[i+2][11], states[i+1][14] * states[i+2][11], states[i+1][15] * states[i+2][13], states[i+1][16] * states[i+2][13], states[i+1][17] * states[i+2][13], states[i+1][18] * states[i+2][11], states[i+1][18] * states[i+2][12], states[i+1][18] * states[i+2][13], states[i+1][18] * states[i+2][14], states[i+1][18] * states[i+2][15], states[i+1][18] * states[i+2][16], states[i+1][18] * states[i+2][17], states[i+1][18] * states[i+2][18]]);
