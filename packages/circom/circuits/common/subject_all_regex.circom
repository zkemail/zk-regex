...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[4][i].in[12] <== eq[22][i].out;
		multi_or[4][i].in[13] <== eq[23][i].out;
		...
		lt[11][i].in[1] <== 191;
		and[27][i] = AND();
		and[27][i].a <== lt[10][i].out;
		and[27][i].b <== lt[11][i].out;
		and[28][i] = AND();
		...
		multi_or[5][i].in[4] <== eq[30][i].out;
		multi_or[5][i].in[5] <== eq[31][i].out;
		multi_or[5][i].in[6] <== eq[32][i].out;
		multi_or[5][i].in[7] <== eq[33][i].out;
		multi_or[5][i].in[8] <== eq[34][i].out;
		multi_or[5][i].in[9] <== eq[35][i].out;
		multi_or[5][i].in[10] <== eq[36][i].out;
		multi_or[5][i].in[11] <== eq[37][i].out;
		multi_or[5][i].in[12] <== eq[38][i].out;
		multi_or[5][i].in[13] <== eq[39][i].out;
		and[29][i].b <== multi_or[5][i].out;
		and[30][i] = AND();
		and[30][i].a <== states[i][11];
		multi_or[6][i] = MultiOR(14);
		multi_or[6][i].in[0] <== eq[35][i].out;
		multi_or[6][i].in[1] <== eq[33][i].out;
		multi_or[6][i].in[2] <== eq[26][i].out;
		multi_or[6][i].in[3] <== eq[28][i].out;
		multi_or[6][i].in[4] <== eq[37][i].out;
		multi_or[6][i].in[5] <== eq[34][i].out;
		...
		multi_or[6][i].in[12] <== eq[38][i].out;
		multi_or[6][i].in[13] <== eq[32][i].out;
		and[30][i].b <== multi_or[6][i].out;
		and[31][i] = AND();
		and[31][i].a <== states[i][17];
		and[31][i].b <== and[14][i].out;
		multi_or[7][i] = MultiOR(5);
		multi_or[7][i].in[0] <== and[26][i].out;
		multi_or[7][i].in[1] <== and[28][i].out;
		multi_or[7][i].in[2] <== and[29][i].out;
		multi_or[7][i].in[3] <== and[30][i].out;
		multi_or[7][i].in[4] <== and[31][i].out;
		...
		multi_or[10][i].in[0] <== eq[42][i].out;
		...
		states[i+1][17] <== multi_or[12][i].out;
		...
		states[i+1][18] <== multi_or[13][i].out;
