...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		lt[5][i].in[1] <== 223;
		and[15][i] = AND();
		and[15][i].a <== lt[4][i].out;
		and[15][i].b <== lt[5][i].out;
		and[16][i] = AND();
		...
		multi_or[2][i].in[0] <== and[20][i].out;
		...
		multi_or[3][i].in[0] <== eq[11][i].out;
		multi_or[3][i].in[1] <== eq[12][i].out;
		multi_or[3][i].in[2] <== eq[13][i].out;
		multi_or[3][i].in[3] <== eq[14][i].out;
		multi_or[3][i].in[4] <== eq[15][i].out;
		multi_or[3][i].in[5] <== eq[16][i].out;
		multi_or[3][i].in[6] <== eq[17][i].out;
		multi_or[3][i].in[7] <== eq[18][i].out;
		multi_or[3][i].in[8] <== eq[19][i].out;
		multi_or[3][i].in[9] <== eq[20][i].out;
		multi_or[3][i].in[10] <== eq[21][i].out;
		multi_or[3][i].in[11] <== eq[22][i].out;
		multi_or[3][i].in[12] <== eq[23][i].out;
		multi_or[3][i].in[13] <== eq[24][i].out;
		and[22][i].b <== multi_or[3][i].out;
		and[23][i] = AND();
		and[23][i].a <== states[i][16];
		and[23][i].b <== and[17][i].out;
		lt[8][i] = LessEqThan(8);
		lt[8][i].in[0] <== 144;
		lt[8][i].in[1] <== in[i];
		lt[9][i] = LessEqThan(8);
		...
		lt[9][i].in[1] <== 191;
		and[24][i] = AND();
		and[24][i].a <== lt[8][i].out;
		and[24][i].b <== lt[9][i].out;
		and[25][i] = AND();
		...
		multi_or[4][i].in[14] <== eq[39][i].out;
		multi_or[4][i].in[15] <== eq[40][i].out;
		and[26][i].b <== multi_or[4][i].out;
		and[27][i] = AND();
		and[27][i].a <== states[i][18];
		multi_or[5][i] = MultiOR(14);
		multi_or[5][i].in[0] <== eq[14][i].out;
		multi_or[5][i].in[1] <== eq[18][i].out;
		multi_or[5][i].in[2] <== eq[22][i].out;
		multi_or[5][i].in[3] <== eq[12][i].out;
		multi_or[5][i].in[4] <== eq[21][i].out;
		multi_or[5][i].in[5] <== eq[24][i].out;
		multi_or[5][i].in[6] <== eq[13][i].out;
		multi_or[5][i].in[7] <== eq[23][i].out;
		multi_or[5][i].in[8] <== eq[19][i].out;
		...
		multi_or[6][i].in[4] <== and[27][i].out;
		...
		and[30][i].b <== eq[42][i].out;
		and[31][i] = AND();
		and[31][i].a <== states[i][18];
		and[31][i].b <== eq[42][i].out;
		...
		multi_or[9][i].in[0] <== eq[43][i].out;
		multi_or[9][i].in[1] <== eq[44][i].out;
		multi_or[9][i].in[2] <== eq[45][i].out;
		...
		states[i+1][16] <== multi_or[10][i].out;
		...
		and[34][i].b <== eq[46][i].out;
		and[35][i] = AND();
		and[35][i].a <== states[i][18];
		and[35][i].b <== eq[46][i].out;
		...
		multi_or[12][i].in[0] <== and[37][i].out;
		multi_or[12][i].in[1] <== eq[47][i].out;
		multi_or[12][i].in[2] <== eq[48][i].out;
		multi_or[12][i].in[3] <== eq[49][i].out;
		multi_or[12][i].in[4] <== eq[50][i].out;
		multi_or[12][i].in[5] <== eq[51][i].out;
		multi_or[12][i].in[6] <== eq[52][i].out;
		multi_or[12][i].in[7] <== eq[53][i].out;
		multi_or[12][i].in[8] <== eq[54][i].out;
		multi_or[12][i].in[9] <== eq[55][i].out;
		multi_or[12][i].in[10] <== eq[56][i].out;
		multi_or[12][i].in[11] <== eq[57][i].out;
		multi_or[12][i].in[12] <== eq[58][i].out;
		and[38][i].b <== multi_or[12][i].out;
		and[39][i] = AND();
		and[39][i].a <== states[i][18];
		multi_or[13][i] = MultiOR(13);
		multi_or[13][i].in[0] <== and[37][i].out;
		multi_or[13][i].in[1] <== eq[57][i].out;
		multi_or[13][i].in[2] <== eq[47][i].out;
		multi_or[13][i].in[3] <== eq[50][i].out;
	...
	// substrings calculated: [{(18, 18), (10, 13), (11, 18), (12, 11), (16, 13), (17, 13), (18, 15), (14, 11), (10, 18), (18, 17), (18, 16), (10, 14), (15, 13), (10, 15), (10, 11), (10, 12), (10, 16), (18, 11), (10, 17), (18, 14), (18, 13), (13, 11), (18, 12)}]
	signal is_substr0[msg_bytes][24];
	signal is_reveal0[msg_bytes];
	signal output reveal0[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		 // the 0-th substring transitions: [(10, 11), (10, 12), (10, 13), (10, 14), (10, 15), (10, 16), (10, 17), (10, 18), (11, 18), (12, 11), (13, 11), (14, 11), (15, 13), (16, 13), (17, 13), (18, 11), (18, 12), (18, 13), (18, 14), (18, 15), (18, 16), (18, 17), (18, 18)]
		...
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][11] * states[i+2][18];
		is_substr0[i][10] <== is_substr0[i][9] + states[i+1][12] * states[i+2][11];
		is_substr0[i][11] <== is_substr0[i][10] + states[i+1][13] * states[i+2][11];
		is_substr0[i][12] <== is_substr0[i][11] + states[i+1][14] * states[i+2][11];
		is_substr0[i][13] <== is_substr0[i][12] + states[i+1][15] * states[i+2][13];
		is_substr0[i][14] <== is_substr0[i][13] + states[i+1][16] * states[i+2][13];
		is_substr0[i][15] <== is_substr0[i][14] + states[i+1][17] * states[i+2][13];
		is_substr0[i][16] <== is_substr0[i][15] + states[i+1][18] * states[i+2][11];
		is_substr0[i][17] <== is_substr0[i][16] + states[i+1][18] * states[i+2][12];
		is_substr0[i][18] <== is_substr0[i][17] + states[i+1][18] * states[i+2][13];
		is_substr0[i][19] <== is_substr0[i][18] + states[i+1][18] * states[i+2][14];
		is_substr0[i][20] <== is_substr0[i][19] + states[i+1][18] * states[i+2][15];
		is_substr0[i][21] <== is_substr0[i][20] + states[i+1][18] * states[i+2][16];
		is_substr0[i][22] <== is_substr0[i][21] + states[i+1][18] * states[i+2][17];
		is_substr0[i][23] <== is_substr0[i][22] + states[i+1][18] * states[i+2][18];
