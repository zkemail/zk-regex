...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[11][i].in[1] <== eq[15][i].out;
		multi_or[11][i].in[2] <== eq[16][i].out;
