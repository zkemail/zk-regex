...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[4][i].in[0] <== eq[14][i].out;
		multi_or[4][i].in[1] <== eq[15][i].out;
		multi_or[4][i].in[2] <== eq[19][i].out;
		multi_or[4][i].in[3] <== eq[20][i].out;
		multi_or[4][i].in[4] <== eq[17][i].out;
		multi_or[4][i].in[5] <== eq[18][i].out;
		multi_or[4][i].in[6] <== eq[16][i].out;
		multi_or[4][i].in[7] <== eq[13][i].out;
		multi_or[4][i].in[8] <== eq[24][i].out;
		multi_or[4][i].in[9] <== eq[21][i].out;
		multi_or[4][i].in[10] <== eq[22][i].out;
		...
		multi_or[5][i].in[0] <== eq[25][i].out;
		multi_or[5][i].in[1] <== eq[26][i].out;
		multi_or[5][i].in[2] <== eq[27][i].out;
		multi_or[5][i].in[3] <== eq[28][i].out;
		multi_or[5][i].in[4] <== eq[29][i].out;
		multi_or[5][i].in[5] <== eq[30][i].out;
		multi_or[5][i].in[6] <== eq[31][i].out;
		multi_or[5][i].in[7] <== eq[32][i].out;
		multi_or[5][i].in[8] <== eq[33][i].out;
		multi_or[5][i].in[9] <== eq[34][i].out;
		multi_or[5][i].in[10] <== eq[35][i].out;
		multi_or[5][i].in[11] <== eq[36][i].out;
		multi_or[5][i].in[12] <== eq[37][i].out;
		multi_or[5][i].in[13] <== eq[38][i].out;
		multi_or[5][i].in[14] <== eq[39][i].out;
		multi_or[5][i].in[15] <== eq[40][i].out;
		...
		and[39][i] = AND();
		and[39][i].a <== states[i][10];
		multi_or[13][i] = MultiOR(13);
		multi_or[13][i].in[0] <== and[37][i].out;
		multi_or[13][i].in[1] <== eq[55][i].out;
		multi_or[13][i].in[2] <== eq[57][i].out;
		multi_or[13][i].in[3] <== eq[50][i].out;
		multi_or[13][i].in[4] <== eq[52][i].out;
		multi_or[13][i].in[5] <== eq[53][i].out;
		multi_or[13][i].in[6] <== eq[54][i].out;
		multi_or[13][i].in[7] <== eq[49][i].out;
		multi_or[13][i].in[8] <== eq[58][i].out;
		multi_or[13][i].in[9] <== eq[51][i].out;
		multi_or[13][i].in[10] <== eq[56][i].out;
		multi_or[13][i].in[11] <== eq[47][i].out;
	...
	// substrings calculated: [{(11, 18), (18, 13), (18, 11), (10, 16), (10, 18), (10, 13), (15, 13), (18, 14), (10, 15), (10, 12), (18, 15), (18, 18), (18, 17), (12, 11), (10, 14), (10, 17), (17, 13), (18, 12), (10, 11), (13, 11), (18, 16), (14, 11), (16, 13)}]
