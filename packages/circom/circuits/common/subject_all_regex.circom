...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[3] <== and[17][i].out;
		...
		multi_or[5][i].in[0] <== eq[20][i].out;
		multi_or[5][i].in[1] <== eq[11][i].out;
		multi_or[5][i].in[2] <== eq[15][i].out;
		multi_or[5][i].in[3] <== eq[18][i].out;
		multi_or[5][i].in[4] <== eq[19][i].out;
		...
		multi_or[5][i].in[10] <== eq[22][i].out;
		multi_or[5][i].in[11] <== eq[14][i].out;
		multi_or[5][i].in[12] <== eq[21][i].out;
		multi_or[5][i].in[13] <== eq[17][i].out;
		and[26][i].b <== multi_or[5][i].out;
		and[27][i] = AND();
		and[27][i].a <== states[i][16];
		and[27][i].b <== and[16][i].out;
		...
		lt[11][i].in[1] <== 127;
		and[36][i] = AND();
		and[36][i].a <== lt[10][i].out;
		and[36][i].b <== lt[11][i].out;
		eq[47][i] = IsEqual();
		eq[47][i].in[0] <== in[i];
		eq[47][i].in[1] <== 0;
		eq[48][i] = IsEqual();
		...
		multi_or[13][i].in[1] <== eq[58][i].out;
		multi_or[13][i].in[2] <== eq[51][i].out;
		multi_or[13][i].in[3] <== eq[47][i].out;
		multi_or[13][i].in[4] <== eq[57][i].out;
		multi_or[13][i].in[5] <== eq[50][i].out;
		multi_or[13][i].in[6] <== eq[53][i].out;
		multi_or[13][i].in[7] <== eq[55][i].out;
		multi_or[13][i].in[8] <== eq[54][i].out;
		multi_or[13][i].in[9] <== eq[56][i].out;
		multi_or[13][i].in[10] <== eq[52][i].out;
		multi_or[13][i].in[11] <== eq[49][i].out;
		multi_or[13][i].in[12] <== eq[48][i].out;
		and[38][i].b <== multi_or[13][i].out;
		and[39][i] = AND();
		and[39][i].a <== states[i][11];
		and[39][i].b <== and[16][i].out;
	...
	// substrings calculated: [{(17, 13), (10, 12), (13, 11), (12, 11), (18, 13), (18, 14), (18, 18), (10, 15), (10, 11), (18, 16), (18, 12), (10, 14), (18, 17), (18, 15), (10, 16), (14, 11), (15, 13), (10, 17), (18, 11), (16, 13), (10, 18), (10, 13), (11, 18)}]
