...
template SubjectAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[12] <== eq[24][i].out;
		multi_or[2][i].in[13] <== eq[25][i].out;
		...
		multi_or[3][i].in[0] <== eq[26][i].out;
		multi_or[3][i].in[1] <== eq[27][i].out;
		...
		and[28][i].b <== eq[42][i].out;
		and[29][i] = AND();
		and[29][i].a <== states[i][18];
		and[29][i].b <== eq[42][i].out;
		...
		and[34][i].b <== eq[47][i].out;
		and[35][i] = AND();
		and[35][i].a <== states[i][18];
		and[35][i].b <== eq[47][i].out;
		...
		multi_or[10][i].in[1] <== eq[48][i].out;
		multi_or[10][i].in[2] <== eq[49][i].out;
		multi_or[10][i].in[3] <== eq[50][i].out;
		multi_or[10][i].in[4] <== eq[51][i].out;
		multi_or[10][i].in[5] <== eq[52][i].out;
		multi_or[10][i].in[6] <== eq[53][i].out;
		multi_or[10][i].in[7] <== eq[54][i].out;
		multi_or[10][i].in[8] <== eq[55][i].out;
		multi_or[10][i].in[9] <== eq[56][i].out;
		multi_or[10][i].in[10] <== eq[57][i].out;
		multi_or[10][i].in[11] <== eq[58][i].out;
		multi_or[10][i].in[12] <== eq[59][i].out;
