...
template FromAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[4] <== and[12][i].out;
		...
		multi_or[6][i].in[4] <== and[19][i].out;
