...
template FromAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[10] <== eq[18][i].out;
		multi_or[2][i].in[11] <== eq[7][i].out;
		...
		multi_or[7][i].in[10] <== eq[44][i].out;
		multi_or[7][i].in[11] <== eq[45][i].out;
		multi_or[7][i].in[12] <== eq[46][i].out;
		multi_or[7][i].in[13] <== eq[47][i].out;
		multi_or[7][i].in[14] <== eq[48][i].out;
		multi_or[7][i].in[15] <== eq[49][i].out;
		and[24][i].b <== multi_or[7][i].out;
		and[25][i] = AND();
		and[25][i].a <== states[i][7];
		multi_or[8][i] = MultiOR(14);
		multi_or[8][i].in[0] <== eq[30][i].out;
		multi_or[8][i].in[1] <== eq[20][i].out;
		multi_or[8][i].in[2] <== eq[31][i].out;
		multi_or[8][i].in[3] <== eq[21][i].out;
		multi_or[8][i].in[4] <== eq[33][i].out;
		multi_or[8][i].in[5] <== eq[32][i].out;
		multi_or[8][i].in[6] <== eq[23][i].out;
		multi_or[8][i].in[7] <== eq[25][i].out;
		multi_or[8][i].in[8] <== eq[29][i].out;
		multi_or[8][i].in[9] <== eq[28][i].out;
		multi_or[8][i].in[10] <== eq[22][i].out;
		multi_or[8][i].in[11] <== eq[27][i].out;
		multi_or[8][i].in[12] <== eq[26][i].out;
		multi_or[8][i].in[13] <== eq[24][i].out;
		...
		multi_or[13][i].in[0] <== eq[54][i].out;
		...
		multi_or[14][i].in[1] <== and[34][i].out;
		...
		multi_or[15][i].in[1] <== and[36][i].out;
	...
	// substrings calculated: [{(8, 8), (7, 15), (8, 9), (7, 13), (14, 11), (8, 15), (12, 9), (7, 14), (8, 10), (8, 14), (9, 8), (11, 9), (7, 12), (8, 12), (8, 13), (10, 9), (7, 8), (15, 11), (8, 11), (7, 9), (7, 11), (13, 11), (7, 10)}]
