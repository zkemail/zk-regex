...
template FromAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[4][i].in[10] <== eq[14][i].out;
		multi_or[4][i].in[11] <== eq[17][i].out;
		multi_or[4][i].in[12] <== eq[21][i].out;
		...
		multi_or[10][i].in[2] <== eq[41][i].out;
		...
		multi_or[14][i].in[1] <== eq[46][i].out;
		multi_or[14][i].in[2] <== eq[51][i].out;
		multi_or[14][i].in[3] <== eq[48][i].out;
		multi_or[14][i].in[4] <== eq[53][i].out;
		multi_or[14][i].in[5] <== eq[44][i].out;
		multi_or[14][i].in[6] <== eq[45][i].out;
		multi_or[14][i].in[7] <== eq[50][i].out;
		multi_or[14][i].in[8] <== eq[47][i].out;
		multi_or[14][i].in[9] <== eq[55][i].out;
		multi_or[14][i].in[10] <== eq[49][i].out;
		multi_or[14][i].in[11] <== eq[52][i].out;
		multi_or[14][i].in[12] <== eq[54][i].out;
	...
	// substrings calculated: [{(15, 13), (7, 12), (7, 15), (11, 8), (13, 10), (15, 10), (7, 8), (12, 10), (7, 14), (14, 10), (15, 9), (7, 11), (15, 12), (15, 15), (8, 15), (7, 13), (7, 10), (10, 8), (15, 14), (9, 8), (15, 8), (15, 11), (7, 9)}]
