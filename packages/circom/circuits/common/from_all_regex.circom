...
template FromAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[3] <== and[14][i].out;
		...
		multi_or[4][i].in[7] <== eq[19][i].out;
		multi_or[4][i].in[8] <== eq[18][i].out;
		multi_or[4][i].in[9] <== eq[17][i].out;
		multi_or[4][i].in[10] <== eq[16][i].out;
		multi_or[4][i].in[11] <== eq[8][i].out;
		multi_or[4][i].in[12] <== eq[14][i].out;
		...
		and[24][i].b <== multi_or[5][i].out;
		multi_or[6][i] = MultiOR(5);
		multi_or[6][i].in[0] <== and[19][i].out;
		multi_or[6][i].in[1] <== and[20][i].out;
		multi_or[6][i].in[2] <== and[22][i].out;
		multi_or[6][i].in[3] <== and[23][i].out;
		multi_or[6][i].in[4] <== and[24][i].out;
		...
		and[30][i].b <== multi_or[10][i].out;
		multi_or[11][i] = MultiOR(2);
		multi_or[11][i].in[0] <== and[29][i].out;
		...
		multi_or[13][i].in[1] <== eq[44][i].out;
		multi_or[13][i].in[2] <== eq[45][i].out;
		multi_or[13][i].in[3] <== eq[46][i].out;
		multi_or[13][i].in[4] <== eq[47][i].out;
		multi_or[13][i].in[5] <== eq[48][i].out;
		multi_or[13][i].in[6] <== eq[49][i].out;
		multi_or[13][i].in[7] <== eq[50][i].out;
		multi_or[13][i].in[8] <== eq[51][i].out;
		multi_or[13][i].in[9] <== eq[52][i].out;
		multi_or[13][i].in[10] <== eq[53][i].out;
		multi_or[13][i].in[11] <== eq[54][i].out;
		multi_or[13][i].in[12] <== eq[55][i].out;
		and[35][i].b <== multi_or[13][i].out;
		and[36][i] = AND();
		and[36][i].a <== states[i][15];
		multi_or[14][i] = MultiOR(13);
		multi_or[14][i].in[0] <== and[34][i].out;
		multi_or[14][i].in[1] <== eq[55][i].out;
		multi_or[14][i].in[2] <== eq[50][i].out;
		multi_or[14][i].in[3] <== eq[54][i].out;
		multi_or[14][i].in[4] <== eq[51][i].out;
		multi_or[14][i].in[5] <== eq[48][i].out;
		multi_or[14][i].in[6] <== eq[53][i].out;
		multi_or[14][i].in[7] <== eq[46][i].out;
		multi_or[14][i].in[8] <== eq[45][i].out;
		multi_or[14][i].in[9] <== eq[47][i].out;
		multi_or[14][i].in[10] <== eq[52][i].out;
		multi_or[14][i].in[11] <== eq[49][i].out;
		multi_or[14][i].in[12] <== eq[44][i].out;
		and[36][i].b <== multi_or[14][i].out;
		multi_or[15][i] = MultiOR(3);
		multi_or[15][i].in[0] <== and[33][i].out;
		multi_or[15][i].in[1] <== and[35][i].out;
		multi_or[15][i].in[2] <== and[36][i].out;
	...
	// substrings calculated: [{(13, 10), (8, 15), (7, 15), (7, 12), (15, 10), (12, 10), (7, 14), (15, 13), (7, 11), (15, 12), (11, 8), (9, 8), (15, 9), (7, 10), (15, 8), (15, 11), (15, 14), (7, 8), (15, 15), (10, 8), (14, 10), (7, 9), (7, 13)}]
