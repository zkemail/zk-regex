...
template FromAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[2] <== and[13][i].out;
		multi_or[0][i].in[3] <== and[15][i].out;
		multi_or[0][i].in[4] <== and[16][i].out;
		states[i+1][8] <== multi_or[0][i].out;
		eq[7][i] = IsEqual();
		eq[7][i].in[0] <== in[i];
		eq[7][i].in[1] <== 224;
		and[17][i] = AND();
		...
		multi_or[2][i].in[7] <== eq[15][i].out;
		multi_or[2][i].in[8] <== eq[16][i].out;
		multi_or[2][i].in[9] <== eq[17][i].out;
		multi_or[2][i].in[10] <== eq[18][i].out;
		multi_or[2][i].in[11] <== eq[19][i].out;
		multi_or[2][i].in[12] <== eq[20][i].out;
		...
		multi_or[3][i].in[0] <== eq[22][i].out;
		multi_or[3][i].in[1] <== eq[23][i].out;
		multi_or[3][i].in[2] <== eq[24][i].out;
		multi_or[3][i].in[3] <== eq[25][i].out;
		multi_or[3][i].in[4] <== eq[26][i].out;
		multi_or[3][i].in[5] <== eq[27][i].out;
		multi_or[3][i].in[6] <== eq[28][i].out;
		multi_or[3][i].in[7] <== eq[29][i].out;
		multi_or[3][i].in[8] <== eq[30][i].out;
		multi_or[3][i].in[9] <== eq[31][i].out;
		multi_or[3][i].in[10] <== eq[32][i].out;
		multi_or[3][i].in[11] <== eq[33][i].out;
		multi_or[3][i].in[12] <== eq[34][i].out;
		multi_or[3][i].in[13] <== eq[35][i].out;
		multi_or[3][i].in[14] <== eq[36][i].out;
		multi_or[3][i].in[15] <== eq[37][i].out;
		...
		multi_or[4][i].in[2] <== and[22][i].out;
		multi_or[4][i].in[3] <== and[23][i].out;
		multi_or[4][i].in[4] <== and[24][i].out;
		...
		multi_or[6][i].in[0] <== and[27][i].out;
		multi_or[6][i].in[1] <== and[28][i].out;
		states[i+1][12] <== multi_or[6][i].out;
		eq[40][i] = IsEqual();
		eq[40][i].in[0] <== in[i];
		eq[40][i].in[1] <== 241;
		eq[41][i] = IsEqual();
		...
		multi_or[7][i].in[0] <== eq[40][i].out;
		multi_or[7][i].in[1] <== eq[41][i].out;
		multi_or[7][i].in[2] <== eq[42][i].out;
		...
		multi_or[10][i].in[1] <== eq[44][i].out;
		multi_or[10][i].in[2] <== eq[45][i].out;
		multi_or[10][i].in[3] <== eq[46][i].out;
		multi_or[10][i].in[4] <== eq[47][i].out;
		multi_or[10][i].in[5] <== eq[48][i].out;
		multi_or[10][i].in[6] <== eq[49][i].out;
		multi_or[10][i].in[7] <== eq[50][i].out;
		multi_or[10][i].in[8] <== eq[51][i].out;
		multi_or[10][i].in[9] <== eq[52][i].out;
		multi_or[10][i].in[10] <== eq[53][i].out;
		multi_or[10][i].in[11] <== eq[54][i].out;
		multi_or[10][i].in[12] <== eq[55][i].out;
		...
		multi_or[11][i].in[2] <== and[36][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i] <== MultiOR(23)([states[i+1][7] * states[i+2][8], states[i+1][7] * states[i+2][9], states[i+1][7] * states[i+2][10], states[i+1][7] * states[i+2][11], states[i+1][7] * states[i+2][12], states[i+1][7] * states[i+2][13], states[i+1][7] * states[i+2][14], states[i+1][7] * states[i+2][15], states[i+1][8] * states[i+2][15], states[i+1][9] * states[i+2][8], states[i+1][10] * states[i+2][8], states[i+1][11] * states[i+2][8], states[i+1][12] * states[i+2][10], states[i+1][13] * states[i+2][10], states[i+1][14] * states[i+2][10], states[i+1][15] * states[i+2][8], states[i+1][15] * states[i+2][9], states[i+1][15] * states[i+2][10], states[i+1][15] * states[i+2][11], states[i+1][15] * states[i+2][12], states[i+1][15] * states[i+2][13], states[i+1][15] * states[i+2][14], states[i+1][15] * states[i+2][15]]);
