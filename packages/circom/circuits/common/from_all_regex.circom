...
template FromAllRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[4][i].in[11] <== eq[13][i].out;
		multi_or[4][i].in[12] <== eq[17][i].out;
		multi_or[4][i].in[13] <== eq[10][i].out;
		...
		multi_or[10][i].in[1] <== eq[40][i].out;
		multi_or[10][i].in[2] <== eq[42][i].out;
		...
		and[34][i].b <== multi_or[13][i].out;
		and[35][i] = AND();
		and[35][i].a <== states[i][15];
		multi_or[14][i] = MultiOR(13);
		multi_or[14][i].in[0] <== and[33][i].out;
		multi_or[14][i].in[1] <== eq[44][i].out;
		multi_or[14][i].in[2] <== eq[52][i].out;
		multi_or[14][i].in[3] <== eq[49][i].out;
		multi_or[14][i].in[4] <== eq[53][i].out;
		multi_or[14][i].in[5] <== eq[51][i].out;
		multi_or[14][i].in[6] <== eq[55][i].out;
		multi_or[14][i].in[7] <== eq[54][i].out;
		multi_or[14][i].in[8] <== eq[50][i].out;
		multi_or[14][i].in[9] <== eq[48][i].out;
		multi_or[14][i].in[10] <== eq[47][i].out;
		multi_or[14][i].in[11] <== eq[46][i].out;
		multi_or[14][i].in[12] <== eq[45][i].out;
	...
	// substrings calculated: [{(14, 10), (7, 8), (15, 8), (7, 14), (15, 14), (15, 15), (7, 10), (12, 10), (11, 8), (7, 11), (15, 9), (15, 12), (7, 9), (13, 10), (15, 10), (15, 13), (9, 8), (8, 15), (7, 12), (7, 15), (15, 11), (10, 8), (7, 13)}]
