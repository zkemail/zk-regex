...
template TimestampRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		and[51][i].b <== multi_or[8][i].out;
		multi_or[10][i] = MultiOR(6);
		multi_or[10][i].in[0] <== and[45][i].out;
		multi_or[10][i].in[1] <== and[46][i].out;
		multi_or[10][i].in[2] <== and[48][i].out;
		multi_or[10][i].in[3] <== and[49][i].out;
		multi_or[10][i].in[4] <== and[50][i].out;
		multi_or[10][i].in[5] <== and[51][i].out;
		states[i+1][23] <== multi_or[10][i].out;
		...
		multi_or[11][i].in[0] <== and[52][i].out;
		multi_or[11][i].in[1] <== and[53][i].out;
		multi_or[11][i].in[2] <== and[54][i].out;
		states[i+1][24] <== multi_or[11][i].out;
		...
		states[i+1][25] <== multi_or[12][i].out;
		...
		multi_or[13][i].in[0] <== eq[55][i].out;
		multi_or[13][i].in[1] <== eq[56][i].out;
		...
		states[i+1][27] <== multi_or[15][i].out;
		...
		multi_or[16][i].in[0] <== eq[61][i].out;
		multi_or[16][i].in[1] <== eq[62][i].out;
		multi_or[16][i].in[2] <== eq[63][i].out;
		multi_or[16][i].in[3] <== eq[64][i].out;
		multi_or[16][i].in[4] <== eq[65][i].out;
		multi_or[16][i].in[5] <== eq[66][i].out;
		multi_or[16][i].in[6] <== eq[67][i].out;
		multi_or[16][i].in[7] <== eq[68][i].out;
		multi_or[16][i].in[8] <== eq[69][i].out;
		multi_or[16][i].in[9] <== eq[70][i].out;
		and[68][i].b <== multi_or[16][i].out;
		and[69][i] = AND();
		and[69][i].a <== states[i][32];
		and[69][i].b <== multi_or[16][i].out;
		multi_or[17][i] = MultiOR(2);
		multi_or[17][i].in[0] <== and[68][i].out;
		multi_or[17][i].in[1] <== and[69][i].out;
		states[i+1][32] <== multi_or[17][i].out;
