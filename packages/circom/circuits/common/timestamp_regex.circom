...
template TimestampRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[7][i].in[1] <== eq[24][i].out;
		multi_or[7][i].in[2] <== eq[25][i].out;
		multi_or[7][i].in[3] <== eq[26][i].out;
		multi_or[7][i].in[4] <== eq[27][i].out;
		multi_or[7][i].in[5] <== eq[28][i].out;
		multi_or[7][i].in[6] <== eq[29][i].out;
		multi_or[7][i].in[7] <== eq[30][i].out;
		multi_or[7][i].in[8] <== eq[31][i].out;
		multi_or[7][i].in[9] <== eq[32][i].out;
		multi_or[7][i].in[10] <== eq[33][i].out;
		multi_or[7][i].in[11] <== eq[34][i].out;
		multi_or[7][i].in[12] <== eq[35][i].out;
		...
		multi_or[8][i].in[11] <== eq[48][i].out;
		multi_or[8][i].in[12] <== eq[49][i].out;
		multi_or[8][i].in[13] <== eq[50][i].out;
		multi_or[8][i].in[14] <== eq[51][i].out;
		multi_or[8][i].in[15] <== eq[52][i].out;
		...
		multi_or[15][i].in[0] <== eq[61][i].out;
		multi_or[15][i].in[1] <== eq[62][i].out;
		multi_or[15][i].in[2] <== eq[63][i].out;
		multi_or[15][i].in[3] <== eq[64][i].out;
		multi_or[15][i].in[4] <== eq[65][i].out;
		multi_or[15][i].in[5] <== eq[66][i].out;
		multi_or[15][i].in[6] <== eq[67][i].out;
		multi_or[15][i].in[7] <== eq[68][i].out;
		multi_or[15][i].in[8] <== eq[69][i].out;
		multi_or[15][i].in[9] <== eq[70][i].out;
