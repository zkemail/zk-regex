...
template TimestampRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[7][i].in[0] <== eq[7][i].out;
		multi_or[7][i].in[1] <== eq[8][i].out;
		multi_or[7][i].in[2] <== eq[9][i].out;
		multi_or[7][i].in[3] <== eq[10][i].out;
		multi_or[7][i].in[4] <== eq[11][i].out;
		multi_or[7][i].in[5] <== eq[12][i].out;
		multi_or[7][i].in[6] <== eq[13][i].out;
		multi_or[7][i].in[7] <== eq[14][i].out;
		multi_or[7][i].in[8] <== eq[15][i].out;
		multi_or[7][i].in[9] <== eq[16][i].out;
		and[13][i].b <== multi_or[7][i].out;
		and[14][i] = AND();
		and[14][i].a <== states[i][26];
		multi_or[8][i] = MultiOR(10);
		multi_or[8][i].in[0] <== eq[7][i].out;
		multi_or[8][i].in[1] <== eq[8][i].out;
		multi_or[8][i].in[2] <== eq[9][i].out;
		multi_or[8][i].in[3] <== eq[10][i].out;
		multi_or[8][i].in[4] <== eq[11][i].out;
		multi_or[8][i].in[5] <== eq[12][i].out;
		multi_or[8][i].in[6] <== eq[13][i].out;
		multi_or[8][i].in[7] <== eq[14][i].out;
		multi_or[8][i].in[8] <== eq[15][i].out;
		multi_or[8][i].in[9] <== eq[16][i].out;
