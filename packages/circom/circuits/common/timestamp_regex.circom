...
template TimestampRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		and[46][i] = AND();
		and[46][i].a <== states[i][26];
		and[46][i].b <== and[28][i].out;
		eq[37][i] = IsEqual();
		eq[37][i].in[0] <== in[i];
		eq[37][i].in[1] <== 139;
		eq[38][i] = IsEqual();
		...
		multi_or[10][i].in[0] <== eq[26][i].out;
		multi_or[10][i].in[1] <== eq[23][i].out;
		multi_or[10][i].in[2] <== eq[30][i].out;
		multi_or[10][i].in[3] <== eq[31][i].out;
		multi_or[10][i].in[4] <== eq[24][i].out;
		multi_or[10][i].in[5] <== eq[34][i].out;
		multi_or[10][i].in[6] <== eq[36][i].out;
		multi_or[10][i].in[7] <== eq[33][i].out;
		multi_or[10][i].in[8] <== eq[29][i].out;
		multi_or[10][i].in[9] <== eq[27][i].out;
		multi_or[10][i].in[10] <== eq[35][i].out;
		multi_or[10][i].in[11] <== eq[25][i].out;
		multi_or[10][i].in[12] <== eq[28][i].out;
		multi_or[10][i].in[13] <== eq[32][i].out;
		...
		multi_or[11][i].in[2] <== eq[28][i].out;
		multi_or[11][i].in[3] <== eq[27][i].out;
		multi_or[11][i].in[4] <== eq[34][i].out;
		multi_or[11][i].in[5] <== eq[24][i].out;
		multi_or[11][i].in[6] <== eq[31][i].out;
		multi_or[11][i].in[7] <== eq[33][i].out;
		multi_or[11][i].in[8] <== eq[23][i].out;
		multi_or[11][i].in[9] <== eq[30][i].out;
		multi_or[11][i].in[10] <== eq[26][i].out;
		multi_or[11][i].in[11] <== eq[35][i].out;
		multi_or[11][i].in[12] <== eq[32][i].out;
		...
		multi_or[12][i].in[3] <== and[48][i].out;
		multi_or[12][i].in[4] <== and[49][i].out;
		...
		multi_or[20][i].in[1] <== eq[69][i].out;
		multi_or[20][i].in[2] <== eq[67][i].out;
		...
		multi_or[20][i].in[8] <== eq[62][i].out;
