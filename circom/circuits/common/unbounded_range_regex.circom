...
// regex: [a-z]{3,}
template UnboundedRangeRegex(maxHaystackBytes, maxMatchBytes) {
    ...
    for (var i = 0; i < maxMatchBytes; i++) {
        ...
        // Transition 4: 4 -[97-122]-> 4
        isValidTransition[4][i] <== CheckByteRangeTransition()(4, 4, 97, 122, currStates[i], nextStates[i], haystack[i]);
