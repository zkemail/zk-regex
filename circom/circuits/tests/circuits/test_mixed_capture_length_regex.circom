...
include "../../common/mixed_capture_length_regex.circom";

// IMPORTANT: These parameters MUST match the maxHaystackBytes and maxMatchBytes
// used in the test file (short_capture.test.ts) when calling genCircuitInputs().
//
// Parameters: MixedCaptureLengthRegex(maxHaystackBytes, maxMatchBytes)
...
component main = MixedCaptureLengthRegex(640, 64);
